...
quesito: '5'
summary: 'Positive integers whose product of all divisors equals 2^{240}'
qa_score: '3'
answer: '$2^{15} \cdot 3^5$'
topics:
  - topic_aritmetica
  - topic_algebra
methods:
...
> Find all positive integers whose product of all positive divisors equals $2^{240}$.
