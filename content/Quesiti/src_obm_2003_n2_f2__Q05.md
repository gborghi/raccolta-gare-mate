...
fase: '2'
quesito: '5'
summary: 'Functional equation f(x)-f(xy)=x/y+y/x: find f(1) and a formula for f(x)'
qa_score: '2'
topics:
  - topic_funzionali
  - topic_algebra
...
> Let $f : \mathbb{R}_+^* \to \mathbb{R}_+^*$ be a function such that $f(x) - f(xy) = \dfrac{x}{y} + \dfrac{y}{x}$, for any $x$ and $y$.
> (a) Calculate $f(1)$.
