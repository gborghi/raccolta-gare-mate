...
quesito: '7'
summary: >-
  Identify which monomial expression cannot equal 24 for suitable positive
  integers a,b,c.
qa_score: '2'
topics:
  - topic_aritmetica
...
# Olimpíada Brasileira de Matemática 2006 — Nível 3 — Fase 1 — Quesito 7

*Identify which monomial expression cannot equal 24 for suitable positive integers a,b,c.*

> Which expression below cannot represent the number 24 for convenient positive integer values of $a$, $b$ and $c$?
> 
