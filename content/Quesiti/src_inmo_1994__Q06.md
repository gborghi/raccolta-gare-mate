...
quesito: '6'
summary: Find all functions satisfying two functional equations
qa_score: '5'
topics:
  - topic_funzionali
  - topic_algebra
...
> $$f(-x) = f(x) \quad \text{and} \quad f(x+1) = f(x) + 1 \quad \text{for all } x,$$
> and
> $$f\!\left(\frac{1}{x}\right) = \frac{f(x)}{x^2} \quad \text{for all } x \ne 0.$$
