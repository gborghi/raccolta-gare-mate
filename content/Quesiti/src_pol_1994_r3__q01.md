...
quesito: '1'
summary: 'Triples of positive rationals with integral sum, reciprocal-sum, product'
qa_score: '5'
topics:
  - topic_aritmetica
  - topic_algebra
...
> Determine all triples $(x, y, z)$ of positive rational numbers such that $x + y + z$, $\frac{1}{x} + \frac{1}{y} + \frac{1}{z}$, and $xyz$ are all integral.
