...
fase: '1'
quesito: '1'
summary: 'How many two-digit numbers are neither prime nor multiples of 2, 3 or 5'
qa_score: '2'
answer: B
topics:
  - topic_aritmetica
...
# Olimpíada Brasileira de Matemática 2001 — Nível 2 — Fase 1 — Quesito 1

*How many two-digit numbers are neither prime nor multiples of 2, 3 or 5*

> How many two-digit numbers are neither prime nor multiples of $2$, $3$ or $5$?
> 
> (A) $1$ \quad (B) $26$ \quad (C) $5$ \quad (D) $4$ \quad (E) more than $4$
