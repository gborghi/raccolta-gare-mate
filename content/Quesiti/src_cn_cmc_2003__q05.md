...
quesito: '5'
summary: Find the minimum value of a two-variable expression subject to a constraint.
qa_score: '2'
answer: '(D) $\frac{12}{5}$'
topics:
  - topic_algebra
...
> Suppose $x, y \in (-2, 2)$ and $xy = -1$. Then the minimum value of $u = \frac{4}{4 - x^2} + \frac{9}{9 - y^2}$ is ( ).
> 
