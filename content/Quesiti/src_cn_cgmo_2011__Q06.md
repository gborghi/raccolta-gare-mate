...
quesito: '6'
summary: 'Existence of positive integers m,n making m^n+1 a perfect square'
qa_score: '5'
topics:
  - topic_aritmetica
methods:
...
> Are there any positive integers $m$, $n$ such that $m^n + 1$ is a perfect square? Prove your conclusion. (posed by Yuan Hanhua)
