...
fase: '1'
quesito: '5'
summary: Maximum value of cryptarithm fraction (MATEM)/(ATJCA)
qa_score: '2'
topics:
  - topic_aritmetica
  - topic_combinatoria
...
> In the expression $\dfrac{M \times A \times T \times E \times M}{A \times T \times J \times C \times A}$, different letters represent different digits and equal letters represent equal digits. What is the greatest possible value of this expression?
> 
