...
quesito: '4'
summary: Six points with pairwise distances summing to i+j
qa_score: '3'
topics:
...
> Let $A_1$, $A_2$, $A_3$, $B_1$, $B_2$, $B_3$ be six points in the plane such that for all integers $i$ and $j$ in $\{1, 2, 3\}$:
> $$A_i B_j = i + j.$$
