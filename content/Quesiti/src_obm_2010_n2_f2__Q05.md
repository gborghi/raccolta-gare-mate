...
fase: '2'
quesito: '5'
summary: 'Integer r,s; quadratic with integer roots; count possible values of |r−s|'
qa_score: '3'
topics:
  - topic_algebra
  - topic_aritmetica
...
> Let $r$ and $s$ be integers. It is known that the quadratic equation
> $$x^2 - (r + s)x + rs + 2010 = 0$$
> has two integer solutions. How many are the possible values of $|r - s|$?
