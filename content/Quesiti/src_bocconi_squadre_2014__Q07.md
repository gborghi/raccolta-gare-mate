---
title: Gara a Squadre 2014 — Quesito 7
tipo: quesito
quesito_id: quesito_src_bocconi_squadre_2014__Q07
...
modalita: a squadre
quesito: '7'
summary: 'Coppie intere (x,y) con (x-y)^2 + 2y^2 <= 27'
qa_score: '3'
answer: >-
  $(-6,-1)$, $(+6,+1)$, $(-4,+1)$, $(+4,-1)$, $(0,-3)$, $(0,+3)$, $(-6,-3)$,
  $(+6,+3)$
topics:
  - topic_aritmetica
  - topic_algebra
...
> Scrivete tutte le coppie $(x, y)$ di numeri interi che soddisfano l'uguaglianza $(x - y)^2 + 2y^2 \le 27$.

**Topic:** [[topic_aritmetica|Aritmetica / Teoria dei Numeri]], [[topic_algebra|Algebra]], [[topic_disuguaglianze|Disuguaglianze]]
