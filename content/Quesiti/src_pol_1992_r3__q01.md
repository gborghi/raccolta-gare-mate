...
quesito: '1'
summary: 'Circumcenter of PAB, prove OP perpendicular to CD'
qa_score: '5'
topics:
...
> Segments $AC$ and $BD$ intersect at $P$ so that $PA = PD$ and $PB = PC$. If $O$ is the circumcenter of triangle $PAB$, prove that $OP$ is perpendicular to $CD$.
