...
quesito: '7'
summary: Numero primo che diventa divisibile per 5 invertendo le cifre
qa_score: '5'
answer: 53 oppure 59
topics:
  - topic_aritmetica
...
> **Trovate un numero primo che diventa divisibile per $5$ quando si invertono le sue due cifre.** (È sufficiente una soluzione)
