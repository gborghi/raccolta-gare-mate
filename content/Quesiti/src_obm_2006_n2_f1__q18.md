...
fase: '1'
quesito: '18'
summary: 'Count positive integer solutions to system a+b=c^2, a+b+c=30'
qa_score: '3'
answer: C
topics:
  - topic_algebra
...
> The number of positive integer solutions of the system
> $$\begin{cases} a + b = c^2 \\ a + b + c = 30 \end{cases}$$
> is:
> 
