...
quesito: '2'
summary: 'Right triangle, angle B exceeds C by 48 degrees'
qa_score: '4'
topics:
...
> There is a right triangle $ABC$ with $\angle A = 90^\circ$. When $\angle B$ is $48^\circ$ larger than $\angle C$, find $\angle B$.
