...
quesito: '4'
summary: 'Count three-element subsets of {1,...,300} with sum divisible by 3'
qa_score: '5'
topics:
  - topic_combinatoria
  - topic_aritmetica
...
> Determine the number of three-element subsets of $\{1, 2, 3, \ldots, 300\}$ for which the sum of the elements is a multiple of 3.
