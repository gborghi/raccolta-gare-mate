...
quesito: '4'
summary: >-
  Prove that an integer n at least 2 is composite iff certain positive integers
  a,b,x,y exist.
qa_score: '3'
topics:
  - topic_aritmetica
...
> Prove that an integer $n \ge 2$ is composite if and only if there are positive integers $a, b, x, y$ with $a + b = n$ and $\frac{x}{a} + \frac{y}{b} = 1$.
