...
quesito: '19'
summary: >-
  Cards with 5 colors in 5 regions; rotations make cards equivalent; count
  distinct cards
qa_score: '3'
answer: C
topics:
...
> Soninha has many cards. Each card has five different colors (green, blue, red, yellow, orange), one in each region of the design. In the figure below, for example, the two cards shown are equal, since one can be rotated to match the other. How many different cards can Soninha produce?
> 
