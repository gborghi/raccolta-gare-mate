...
fase: '1'
quesito: '7'
summary: Minimum marbles so every student gets same number
qa_score: '3'
answer: B
topics:
  - topic_aritmetica
...
# Olimpíada Brasileira de Matemática 2004 — Nível 1 — Fase 1 — Quesito 7

*Minimum marbles so every student gets same number*

> A teacher has $237$ marbles to distribute among her $31$ students. What is the minimum number of marbles she needs to acquire so that all students can receive the same number of marbles, with none left over?
> 
