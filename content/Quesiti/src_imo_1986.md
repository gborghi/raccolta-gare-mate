...
level: IMO
---
<div class="atom-reader" data-gara="Quesiti/src_imo_1986"></div>
...
> A triangle A1A2A3 and a point P0 are given in the plane. We define As = As−3
...
> (for k = 0, 1, 2, . . . ). Prove that if P1986 = P0, then the triangle A1A2A3 is
> equilateral.
...
<span class="atom-split" id="q03" data-atom="q03" data-title="Quesito 3" data-tags="topic_combinatoria,method_invarianti"></span>
...
> Let A, B be adjacent vertices of a regular n-gon (n ≥5) in the plane having
...
<span class="atom-split" id="q05" data-atom="q05" data-title="Quesito 5" data-tags="topic_funzionali,method_casework,skill_astrazione"></span>
...
> (i)
> f(xf(y))f(y) = f(x + y) for all x, y ≥0,
> (ii)
> f(2) = 0,
> (iii)
> f(x) ̸= 0 for 0 ≤x < 2.
...
> One is given a finite set of points in the plane, each point having integer coordinates. Is it always possible to color some of the points in the set red and the
