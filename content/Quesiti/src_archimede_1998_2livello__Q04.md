...
country: Italia
quesito: '4'
summary: Quantità di liquore in bicchiere conico con ciliegina
answer: C
topics:
...
# Archimede Gara 2º livello 1998 — Quesito 4
...
> 
> (A) $\dfrac{2}{3}\pi$ cm$^3$ \quad (B) $\pi$ cm$^3$ \quad (C) $\dfrac{5}{3}\pi$ cm$^3$ \quad (D) $2\pi$ cm$^3$
