...
quesito: '10'
summary: 'Find positive integer k such that sqrt(p^2-p) is integer, p odd prime'
qa_score: '4'
answer: '$\dfrac{(p+1)^2}{4}$'
topics:
  - topic_aritmetica
  - topic_algebra
methods:
...
> Let $p$ be an odd prime. Let $k$ be a positive integer such that $\sqrt{p^2 - pk}$ is also a positive integer. Then $k = $ ___.
