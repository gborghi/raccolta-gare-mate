...
quesito: '7'
summary: Range of x satisfying equation with nested square roots
qa_score: '5'
answer: '\{0\} \cup [4, 20]'
topics:
  - topic_algebra
...
> Suppose real numbers $x$, $y$ satisfy $x - 4\sqrt{y} = 2\sqrt{x - y}$. Then the range of $x$ is $\underline{\qquad}$.
