...
fase: '2'
quesito: '2'
summary: 'Count two-digit composites formed from distinct digits among 2,3,4,5,6'
qa_score: '5'
topics:
  - topic_aritmetica
  - topic_combinatoria
...
> How many composite two-digit numbers can be formed using distinct digits chosen from $\{2, 3, 4, 5, 6\}$?
