...
fase: '1'
quesito: '9'
summary: Three consecutive naturals a<b<c; simplify c^2 - ab
qa_score: '3'
answer: E
topics:
  - topic_algebra
...
> The numbers $a$, $b$, $c$ are consecutive natural numbers in increasing order (so $b = a+1$, $c = a+2$). Then the value of $c^2 - ab$ is equal to:
> 
