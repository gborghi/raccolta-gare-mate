...
quesito: '4'
summary: 'Find all prime triples (p,q,n) with divisibility condition'
qa_score: '3'
answer: '$(3, 3, n)$ for $n = 2, 3, \ldots$'
topics:
  - topic_aritmetica
methods:
  - method_congruenze
...
> Find all triples $(p, q, n)$ such that $p^{n+1}q^{n+1} \mid p^{2n+1} + q^{2n+1} - 3^{2n+1}$, where $p$, $q$ are prime and $n$ is a positive integer.
