...
quesito: '7'
summary: >-
  Among 18 consecutive integers <= 2016, show at least one is divisible by the
  sum of its digits.
qa_score: '5'
topics:
  - topic_aritmetica
...
> Show that among $18$ consecutive integers less than or equal to $2016$, there exists at least one that is divisible by the sum of its digits.
