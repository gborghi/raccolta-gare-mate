...
stagione: automne
quesito: '7'
summary: Does strict ordering of fractions imply ordering of their mediants?
qa_score: '4'
topics:
  - topic_aritmetica
...
> Is it true that, if $a_1$, $a_2$, $b_1$, $b_2$, $c_1$, $d_1$, $c_2$, $d_2$ are strictly positive integers such that
