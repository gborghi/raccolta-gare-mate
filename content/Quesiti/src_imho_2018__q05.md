---
title: IMO 2018 (LIX International Mathematical Olympiad) — Quesito 5
tipo: quesito
quesito_id: quesito_src_imho_2018__Q05
...
quesito: '5'
summary: 'Infinite sequence of positive integers: prove a_m = a_{m+1} for some M'
qa_score: '3'
topics:
  - topic_aritmetica
  - topic_algebra
...
> Let $a_1, a_2, \ldots$ be an infinite sequence of positive integers. Suppose that there is an integer $N > 1$ such that, for each $n \ge N$, the number
...
**Metodo:** [[method_induzione|Induzione]], [[method_telescoping|Telescoping]], [[method_invarianti|Invarianti]]
