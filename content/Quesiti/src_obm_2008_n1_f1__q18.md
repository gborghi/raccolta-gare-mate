...
fase: '1'
quesito: '18'
summary: Erase minimum digits from repeated-2008 number so digit sum equals 2008
qa_score: '3'
answer: B
topics:
  - topic_aritmetica
...
> What is the minimum number of digits that must be erased from the number $\underbrace{20082008\cdots2008}_{\text{1000 digits}}$ (the string "2008" repeated 250 times) so that the sum of the remaining digits equals $2008$?
> 
