...
> (1, poi 2, poi 3, ..., fino a 13). Il malcapitato dovrà servire tanti anni quante sono le righe del triangolo
> più lunghe di quella in cui compare la tessera rossa. Bill “Sputafuoco” Turing, che osserva in disparte, si
> domanda mediamente quanti anni di servizio tocchino in questo modo. Jack non capisce esattamente cosa
> intenda il suo collega π-rata, ma suo figlio Will, che ha studiato, gli spiega che tra i tanti modi di definire il
> numero medio di anni di servizio (tutti che portano allo stesso risultato) quello più comune è la somma dei
> numeri k· pk dove, per ogni numero naturale 0 ≤k ≤12, pk è la probabilità che gli anni di servizio siano k.
> Qual è il numero medio di anni di servizio?
