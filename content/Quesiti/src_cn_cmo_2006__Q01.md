---
title: China Mathematical Olympiad 2006 — Quesito 1
tipo: quesito
quesito_id: quesito_src_cn_cmo_2006__Q01
...
quesito: '1'
summary: Prove a max-square inequality for zero-sum sequences
qa_score: '5'
topics:
...
> Suppose that the real numbers $a_1, a_2, \ldots, a_n$ satisfy $a_1 + a_2 + \cdots + a_n = 0$. Prove
