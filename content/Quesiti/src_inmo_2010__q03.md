...
quesito: '3'
summary: 'Find all non-zero reals x,y,z satisfying a system of equations'
qa_score: '5'
topics:
  - topic_algebra
methods:
...
> $$\left(x^4 + x^2y^2 + y^4\right)\left(y^4 + y^2z^2 + z^4\right)\left(z^4 + z^2x^2 + x^4\right) = x^3y^3z^3.$$
