...
quesito: '4'
summary: >-
  Interior point P with angle conditions; if O (circumcenter) differs from P,
  prove angle APO is right.
qa_score: '5'
topics:
