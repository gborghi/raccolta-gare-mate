...
quesito: '6'
summary: Infiniti m con num. fattori primi dispari di m(m+3) multiplo di 3
topics:
  - topic_aritmetica
methods:
  - method_congruenze
...
> Dimostrare che esistono infiniti interi positivi m tali che il numero di fattori primi distinti dispari di m(m+3)
> è un multiplo di 3.
