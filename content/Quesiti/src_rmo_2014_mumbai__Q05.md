...
quesito: '5'
summary: Prove (1+a^2)(1+b^2)(1+c^2) >= 125 given reciprocal sum at most 1
regioni:
  - Mumbai
  - Region 5
qa_score: '3'
...
> $$\frac{1}{1+a} + \frac{1}{1+b} + \frac{1}{1+c} \le 1.$$
> Prove that $(1 + a^2)(1 + b^2)(1 + c^2) \ge 125$. When does the equality hold?
