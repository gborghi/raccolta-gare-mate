...
stagione: automne
quesito: '7'
summary: 'Find positive integer triples (p,n,m) with p prime and p^n+144=m^2'
qa_score: '5'
topics:
  - topic_aritmetica
methods:
...
> Find all triples of positive integers $(p, n, m)$ such that $p$ is prime and $p^n + 144 = m^2$.
