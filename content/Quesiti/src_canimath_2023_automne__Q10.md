...
quesito: '10'
summary: >-
  5x5 grid of positive integers with every row sum odd; prove some column sum is
  also odd (lycee)
qa_score: '2'
topics:
  - topic_combinatoria
