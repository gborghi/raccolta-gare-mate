...
quesito: '9'
summary: Minimize sum of prefix products of a decreasing non-negative sequence
qa_score: '3'
topics:
  - topic_algebra
...
> (Test Paper B, Problem 2) Given integer $n \geq 2$, let non-negative real numbers $a_1, a_2, \ldots, a_n$ satisfy
