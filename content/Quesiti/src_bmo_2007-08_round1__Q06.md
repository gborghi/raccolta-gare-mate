...
quesito: '6'
summary: >-
  Recurrence on positive integers; prove integer values and count solutions to
  f(n)=2n
qa_score: '2'
topics:
  - topic_aritmetica
...
> The function $f$ is defined on the set of positive integers by $f(1) = 1$, $f(2) = 2$, and
> $$f(n+1) = (1 + (2n + 1)f(n))f(n-1)$$
> for $n \geq 2$.
> 
