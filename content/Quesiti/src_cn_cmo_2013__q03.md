...
quesito: '3'
summary: >-
  Find all positive real t with infinite set X and arithmetic progression
  inequality
qa_score: '5'
answer: '$0 < t < \frac{1}{2}$'
topics:
...
> Find all positive real numbers $t$ with the property that there exists an infinite set $X$ of real numbers such that the inequality
