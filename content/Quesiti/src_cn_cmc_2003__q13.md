...
quesito: '13'
summary: Prove a sum of three square roots is bounded above by a constant.
qa_score: '2'
topics:
...
> Suppose $\frac{1}{2} \le x \le 5$. Prove that $2\sqrt{x+1} + \sqrt{2x-3} + \sqrt{15-3x} < 2\sqrt{19}$.
