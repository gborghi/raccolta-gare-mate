...
> 
> 6. $\alpha$ sia un reale appartenente all'intervallo $\left[\frac{9}{7}\,;\,2\right]$ e $(u_n)$ la sequenza associata ad esso. a. Per ogni $x$ reale, un set $P(x) = \alpha x^3 - x - 1$ e $Q(x) = 8x^3 - 116 x^2 + 494 x - 441$. Mostra che < MSK0/> b. Studiare le variazioni della funzione < MSK7/> sull'intervallo < MSK8/> e della funzione < MSK9/> sull'intervallo < MSK10/>. c. Qual è il segno di < MSK11/? d. Confronta i reali $\frac{11 - 2\alpha}{7}$ e $-u_3$. e. Il vero $\alpha$ verifica la proprietà $\mathscr{B}$?
> 
