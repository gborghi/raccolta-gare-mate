...
quesito: '13'
summary: 'Find value of a given two equations in positive integers a,b,c with a>c'
qa_score: '4'
topics:
  - topic_algebra
  - topic_aritmetica
...
> Three positive integers $a, b, c$ with $a > c$ satisfy the following equations:
> $$ac + b + c = bc + a + 66, \quad a + b + c = 32.$$
> Find the value of $a$.
