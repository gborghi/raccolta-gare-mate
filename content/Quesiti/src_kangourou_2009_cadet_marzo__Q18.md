...
> Vogliamo colorare le celle della griglia in
> figura usando i quattro colori diversi X, Y, Z, W
> in modo che due celle che sono a contatto non
> ricevano mai lo stesso colore (due celle si considerano a contatto se hanno in comune almeno un
> vertice). La figura mostra che alcuni colori sono
> già stati assegnati. Con quali colori può essere
> colorata la cella ombreggiata?
> A) Solo Y.
> B) Solo Z.
> C) Solo W.
