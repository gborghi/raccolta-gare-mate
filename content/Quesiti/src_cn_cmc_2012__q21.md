...
quesito: '21'
summary: 'Find all pairs (a,b) so f(f(x))>=f(x) for all real x'
qa_score: '5'
answer: '$\{(a,b) \mid 0 < b \le 1,\; 0 < a < 1,\; 2a + b \le 2\}$'
topics:
  - topic_algebra
...
> (20 marks) Find all real number pairs $(a, b)$, such that $f(x) = ax^2 + b$ satisfies $f(f(x)) \ge f(x)$ for any real numbers $x$.
