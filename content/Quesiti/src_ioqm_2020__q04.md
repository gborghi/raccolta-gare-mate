...
quesito: '4'
summary: 'Rectangle ABCD, AB+BC+CD=20, AE=9, E midpoint of BC; find area'
qa_score: '3'
topics:
...
> Let $ABCD$ be a rectangle in which $AB + BC + CD = 20$ and $AE = 9$ where $E$ is the mid-point of the side $BC$. Find the area of the rectangle.
