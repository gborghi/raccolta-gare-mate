...
quesito: '5'
summary: 'Primes p,q,r with q|p-1, r|p-1; find all values of pq'
qa_score: '3'
topics:
  - topic_aritmetica
methods:
...
> Let $p$, $q$ and $r$ be prime numbers. It is given that $q$ divides $p - 1$, and $r$ divides $p - 1$. Determine all possible values of $pq$.
