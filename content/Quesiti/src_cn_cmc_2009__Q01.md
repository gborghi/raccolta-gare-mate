...
quesito: '1'
summary: Compute iterated composition f^(99)(1) for f(x)=x/sqrt(1+x^2)
qa_score: '3'
answer: '\dfrac{1}{10}'
topics:
  - topic_algebra
...
> Suppose that $f(x) = \dfrac{x}{\sqrt{1+x^2}}$ and $f^{(99)}(x) = f[f[\cdots f(x)\cdots]]$ (99 compositions). Then $f^{(99)}(1) = $ \_\_\_\_.
