...
quesito: '2'
summary: 'Cubic with three positive roots: prove coefficient inequality'
qa_score: '2'
topics:
  - topic_algebra
...
> The real polynomial $\varphi(x) = ax^3 + bx^2 + cx + d$ has three positive roots, and $\varphi(0) < 0$. Prove that
