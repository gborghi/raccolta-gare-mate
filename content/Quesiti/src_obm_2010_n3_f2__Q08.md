...
fase: '2'
quesito: '8'
summary: 'Solve integer system x+y+z=77, xy+yz+2x+xyz=946 with x≤y≤z non-negative'
qa_score: '3'
topics:
  - topic_algebra
  - topic_aritmetica
...
# Olimpíada Brasileira de Matemática 2010 — Nível 3 — Fase 2 — Quesito 8

*Solve integer system x+y+z=77, xy+yz+2x+xyz=946 with x≤y≤z non-negative*

> Solve the system
> $$\begin{cases} x + y + z = 77 \\ xy + yz + 2x + xyz = 946 \end{cases}$$
> where $x \le y \le z$ are non-negative integers.
