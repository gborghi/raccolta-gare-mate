---
title: Olimpíada Brasileira de Matemática 2001 — Nível 1 — Fase 1 — Quesito 18
tipo: quesito
quesito_id: quesito_src_obm_2001_n1_f1__Q18
...
fase: '1'
quesito: '18'
summary: Sum of all numbers from 1 to 999 in which the digit 1 appears exactly twice
qa_score: '4'
answer: A
topics:
  - topic_combinatoria
...
> All the numbers from $1$ to $999$ in which the digit $1$ appears exactly $2$ times (such as $11$, $121$, $411$, etc.) are written. The sum of all these numbers is:
> 
