...
fase: '1'
quesito: '15'
summary: Number of distinct distances between points in a 4x4 grid
qa_score: '2'
answer: C
topics:
...
> How many distinct distances are possible between two distinct points of the $4 \times 4$ grid shown below? The points are distributed in rows and columns equally spaced from one another by one unit.
> 
