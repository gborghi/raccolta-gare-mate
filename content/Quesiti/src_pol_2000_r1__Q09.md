...
quesito: '9'
summary: 'Positive integers m,n with mn dividing m^2+n^2+m; prove m is a perfect square.'
qa_score: '4'
topics:
  - topic_aritmetica
methods:
...
> Suppose that positive integers $m$ and $n$ are such that $mn$ divides $m^2 + n^2 + m$. Prove that $m$ is a perfect square.
