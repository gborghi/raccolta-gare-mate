...
fase: '1'
quesito: '3'
summary: Smallest possible sum of hidden faces of three stacked numbered cubes
qa_score: '3'
topics:
  - topic_aritmetica
...
> In the drawing beside, three equal cubes are supported on a table. Each cube has on its faces the numbers $0$, $1$, $3$, $4$, $5$, $9$, where each number appears exactly once. What is the smallest sum that can be obtained over the faces that touch the table or another cube?
> 
