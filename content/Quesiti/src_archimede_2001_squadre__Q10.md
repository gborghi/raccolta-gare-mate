...
# Archimede 2001 - Gara Nazionale a Squadre (Cesenatico) — Quesito 10
...
> 
> «Usando il metodo di 'Rtenio' (NdR: un noto matematico Qwghlmiano) si conclude che le radici del polinomio
> $$\alpha x^2 - \beta x + \alpha + \beta - \gamma = 0$$
> sono tutte intere»
> 
