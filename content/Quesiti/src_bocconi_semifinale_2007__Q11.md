...
quesito: '11'
summary: Valore minimo della somma massima di tre consecutivi su cerchio con 1-16
qa_score: '3'
answer: '18'
topics:
  - topic_aritmetica
...
> Chiamiamo con $M$ la somma maggiore di tre numeri scritti di seguito sulla circonferenza di un cerchio. Si inseriscono tutti i numeri interi da 1 a 16 sulla circonferenza (il 10 e il 16 sono già scritti). Si vuole che il valore di $M$ sia il più piccolo possibile.
> 
