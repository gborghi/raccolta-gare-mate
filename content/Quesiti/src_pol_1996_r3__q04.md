...
quesito: '4'
summary: >-
  Tetrahedron ABCD with angle BAC = angle ACD and angle CDB = angle DBA; prove
  AB = CD.
qa_score: '5'
topics:
...
> Suppose that a tetrahedron $ABCD$ is such that $\angle BAC = \angle ACD$ and $\angle CDB = \angle DBA$. Prove that $AB = CD$.
