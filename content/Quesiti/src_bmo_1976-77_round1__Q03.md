...
quesito: '3'
summary: Schur-type inequality and a sixth-degree symmetric inequality
qa_score: '4'
topics:
...
# British Mathematical Olympiad 1976-77 — Round 1 — Quesito 3
...
> $$a^6 + b^6 + c^6 + 3a^2 b^2 c^2 \ge 2(b^3 c^3 + c^3 a^3 + a^3 b^3).$$
