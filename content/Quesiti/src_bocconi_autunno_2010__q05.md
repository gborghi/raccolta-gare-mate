...
quesito: '5'
summary: Rettangolo magico 2×4 con gli interi da 1 a 8
qa_score: '4'
...
> Scrivere tutti i numeri interi da 1 a 8 nelle caselle del rettangolo in modo che:
> • la somma dei due numeri di ogni colonna sia sempre la stessa;
