...
quesito: '16'
summary: Piu grande di 8 numeri (5 consecutivi = 3 seguenti)
answer: D
topics:
  - topic_algebra
skills:
...
> 16. Risposta D) . Se x è il primo degli interi considerati abbiamo 5 x + (1+2+3+4) = 3 x +(5+6+7) quindi 2x = 8 e il numero richiesto è x +7 = 11.
