...
quesito: '1'
summary: Find all positive integer pairs with prime average and integer factorial ratio
qa_score: '5'
topics:
  - topic_aritmetica
  - topic_combinatoria
...
> Find all pairs of positive integers $(x, y)$ satisfying the following two conditions:
> \begin{itemize}
> \item The average of $x$ and $y$ is a prime number.
> \item $\dfrac{x! + y!}{x + y}$ is an integer.
> \end{itemize}
