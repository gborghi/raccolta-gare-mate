...
fase: '1'
quesito: '16'
summary: 'Smallest real k such that 2x^2-12xy+ky^2>=0 for all real x,y.'
qa_score: '4'
topics:
  - topic_algebra
...
> It is known that $2x^2 - 12xy + ky^2 \ge 0$ for all real $x$, $y$. The smallest real value of $k$ is (A) $9$ (B) $16$ (C) $18$ (D) $27$ (E) $36$
