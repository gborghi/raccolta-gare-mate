...
quesito: '21'
summary: >-
  Minimum distance in metres between ladybird (30 cm/min along QR) and spider
  (40 cm/min along RT) in 10 m square garden
qa_score: '4'
answer: D
topics:
...
> 
> What is the shortest distance between them, in metres?
>
> - **(A)** 5
> - **(B)** 6
> - **(C)** $5\sqrt{2}$
