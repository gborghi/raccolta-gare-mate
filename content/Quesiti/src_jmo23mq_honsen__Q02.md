...
quesito: '2'
summary: Find all integer functions satisfying a functional equation
qa_score: '4'
topics:
  - topic_funzionali
  - topic_aritmetica
...
> Find all functions $f$ defined on the integers and taking real values such that, for any integers $m,n$,
