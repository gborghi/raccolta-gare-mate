...
quesito: '16'
summary: Difference of two double sums over pairs with odd vs even sum
qa_score: '5'
answer: '55'
topics:
  - topic_algebra
...
> $$\sum_{\substack{1 \le i < j \le 10 \\ i+j=\text{odd}}} (i+j) - \sum_{\substack{1 \le i < j \le 10 \\ i+j=\text{even}}} (i+j)\,?$$
