...
fase: '1'
quesito: '20'
summary: 'Count 4-digit ''paladino'' numbers: multiples of 9 with no zero digit'
qa_score: '4'
topics:
  - topic_aritmetica
  - topic_combinatoria
...
# Olimpíada Brasileira de Matemática 2008 — Nível 3 — Fase 1 — Quesito 20

*Count 4-digit 'paladino' numbers: multiples of 9 with no zero digit*

> A four-digit number is called *paladino* if it is a multiple of $9$ and none of its digits is zero. How many paladino numbers exist?
> 
