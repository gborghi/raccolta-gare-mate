...
quesito: '1'
summary: Prove infinitely many of the numbers 50^n+(50n+1)^50 are composite.
qa_score: '5'
topics:
  - topic_aritmetica
methods:
...
> Prove that among the numbers $50^n + (50n+1)^{50}$, where $n \in \mathbb{N}$, there are infinitely many composite numbers.
