...
fase: '2'
quesito: '2'
summary: 'Max value of ab+bc+cd+da for a,b,c,d a permutation of 1,2,3,4'
qa_score: '3'
topics:
  - topic_algebra
  - topic_aritmetica
...
> If $a$, $b$, $c$, and $d$ are, in some order, the numbers $1$, $2$, $3$, and $4$, what is the largest possible value of
> $$ab + bc + cd + da?$$
