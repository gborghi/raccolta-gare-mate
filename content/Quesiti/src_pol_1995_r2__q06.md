...
quesito: '6'
summary: >-
  Determine all positive integers n for which an n x n square can be cut into
  2x2 and 3x3 squares (sides parallel to the big square).
qa_score: '5'
topics:
  - topic_combinatoria
methods:
...
> Determine all positive integers $n$ for which the square $n \times n$ can be cut into squares $2 \times 2$ and $3 \times 3$ (with the sides parallel to the sides of the big square).
