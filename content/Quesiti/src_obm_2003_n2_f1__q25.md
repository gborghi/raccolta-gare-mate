...
fase: '1'
quesito: '25'
summary: 'Right triangle ABC; BD=8, EC=9; find angle DAE'
qa_score: '3'
answer: C
topics:
...
> In triangle $ABC$, we have $AB = 20$, $AC = 21$, and $BC = 29$. Points $D$ and $E$ are on side $BC$ with $BD = 8$ and $EC = 9$. Find the measure of angle $\angle DAE$, in degrees.
> 
