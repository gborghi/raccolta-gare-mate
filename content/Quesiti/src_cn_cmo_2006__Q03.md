...
quesito: '3'
summary: Prove one of two Diophantine equations has an odd solution
qa_score: '5'
topics:
  - topic_aritmetica
methods:
...
> $$x^2 + 11y^2 = 4m \quad \text{and} \quad x^2 + 11y^2 = 4n$$
> has a solution $(x_0, y_0)$ with $x_0$, $y_0$ being odd numbers.
