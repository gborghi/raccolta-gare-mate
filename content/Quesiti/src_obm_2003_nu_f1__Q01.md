...
fase: '1'
quesito: '1'
summary: Volume of convex polyhedron with integer vertices on sphere radius sqrt(2)
qa_score: '5'
topics:
...
# Olimpíada Brasileira de Matemática 2003 — Nível Universitário — Fase 1 — Quesito 1
