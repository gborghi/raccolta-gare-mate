...
quesito: '10'
summary: Prove x^9 = y^3 + z^3 has infinitely many solutions in positive integers
qa_score: '4'
topics:
  - topic_aritmetica
  - topic_algebra
...
> Prove that the equation $x^9 = y^3 + z^3$ has infinitely many solutions in positive integers $x, y, z$.
