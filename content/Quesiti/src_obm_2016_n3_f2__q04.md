...
fase: '2'
quesito: '4'
summary: Smallest perimeter shared by two non-congruent integer-sided right triangles
qa_score: '3'
topics:
  - topic_aritmetica
  - topic_combinatoria
...
> Determine the smallest positive integer $n$ such that there exist two non-congruent right triangles with integer side lengths and perimeter $n$.
