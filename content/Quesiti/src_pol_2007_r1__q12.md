---
title: Olimpiade Matematica Polacca 2007 — Round 1 — Quesito 12
tipo: quesito
quesito_id: quesito_src_pol_2007_r1__Q12
...
quesito: '12'
summary: >-
  Express a polynomial positive on [a,b] as P^2 plus (x-a)(b-x) times a sum of
  squares.
qa_score: '4'
topics:
  - topic_algebra
...
> A polynomial $W$ with real coefficients takes only positive values on the segment $[a,b]$ ($a<b$). Show that there exist polynomials $P$ and $Q_1,Q_2,\ldots,Q_m$ such that
> $$W(x)=P(x)^2+(x-a)(b-x)\sum_{i=1}^{m}Q_i(x)^2 \quad\text{for all real }x.$$
