...
fase: '1'
quesito: '3'
summary: 2% increase of integer equals successor; find their sum
qa_score: '3'
answer: D
topics:
  - topic_algebra
...
# Olimpíada Brasileira de Matemática 2010 — Nível 1 — Fase 1 — Quesito 3

*2% increase of integer equals successor; find their sum*

> Increasing a positive integer by $2\%$ of itself yields its successor (the next integer). What is the sum of these two numbers?
> 
