...
quesito: '1'
summary: 'Prove no integer solution to $x^n+y^n=z^n$ with $0<x\le n$, $0<y\le n$'
qa_score: '4'
topics:
  - topic_aritmetica
methods:
...
> Prove that the equation $x^n + y^n = z^n$, where $n$ is an integer $> 1$, has no solution in integers $x$, $y$, $z$, with $0 < x \le n$, $0 < y \le n$.
