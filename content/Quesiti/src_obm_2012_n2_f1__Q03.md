...
fase: '1'
quesito: '3'
summary: Count of 'bacium' numbers (3.5 times an integer) in a range
qa_score: '2'
topics:
  - topic_aritmetica
  - topic_combinatoria
...
> In a certain context a number is called a bacium if it is an integer that is $3{,}5$ times another integer. For example, $3{,}5$ is a bacium, since it is $3{,}5$ times $1$. How many bacium numbers exist between $2{,}1$ and $33{,}3$?
> 
