...
stagione: printemps
quesito: '8'
summary: 'Primes p,q,r; pq+1, pr+1, qr-p squares; prove p+2qr+2 is also a square'
qa_score: '4'
topics:
  - topic_aritmetica
  - topic_algebra
...
> Let $p$, $q$, $r$ be prime numbers such that each of the three numbers $pq + 1$, $pr + 1$, and $qr - p$ is a perfect square. Prove that $p + 2qr + 2$ is also a perfect square.
