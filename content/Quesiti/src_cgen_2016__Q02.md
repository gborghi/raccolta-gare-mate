...
quesito: '2'
summary: >-
  The row of trees that hides the forest: an observer at the origin among trees
  (discs of radius R centred at lattice points); determine for which R every
  direction is blocked, using slope rationality and parity arguments.
qa_score: '2'
topics:
