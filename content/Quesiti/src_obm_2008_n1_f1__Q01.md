...
fase: '1'
quesito: '1'
summary: Segments of 1 cm to form equilateral triangles; which count is impossible
qa_score: '3'
answer: A
topics:
  - topic_aritmetica
...
> With segments of 1 cm in length we can form triangles. For example, with nine segments we can form an equilateral triangle of side 3. With which number of segments is it impossible to form an equilateral triangle?
> 
