...
quesito: '7'
summary: Find a+b for iterated linear function with given seventh iterate
qa_score: '4'
answer: '5'
topics:
  - topic_algebra
...
> Let $f(x) = ax + b$, with $a, b$ real numbers; $f_1(x) = f(x)$, $f_{n+1}(x) = f(f_n(x))$, $n = 1, 2, \ldots$ If $f_7(x) = 128x + 381$, then $a + b = $ ________.
