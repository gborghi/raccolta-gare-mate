...
quesito: '6'
summary: Find positive integer quadruples with 2^a 3^b + 4^c 5^d = 2^b 3^a + 4^d 5^c
qa_score: '2'
topics:
  - topic_aritmetica
  - topic_algebra
...
# Japan IMO Selection Camp 2024 — Selection Camp — Quesito 6

*Find positive integer quadruples with 2^a 3^b + 4^c 5^d = 2^b 3^a + 4^d 5^c*

> Find all quadruples $(a, b, c, d)$ of positive integers satisfying
> $$2^a 3^b + 4^c 5^d = 2^b 3^a + 4^d 5^c.$$
