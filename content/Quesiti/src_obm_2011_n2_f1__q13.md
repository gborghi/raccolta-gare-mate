...
fase: '1'
quesito: '13'
summary: Hypotenuse XY of right triangle from the two medians to the legs
qa_score: '3'
topics:
...
> Let $XOY$ be a right triangle with $X\hat{O}Y = 90^\circ$. Let $M$ and $N$ be the midpoints of the legs $OX$ and $OY$, respectively. Given that $XN = 19$ and $YM = 22$, determine the measure of segment $XY$.
> 
