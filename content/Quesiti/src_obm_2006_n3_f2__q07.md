...
fase: '2'
quesito: '7'
summary: 'Find all positive integer pairs (a,b) with (a+1)(b+1) divisible by ab+1'
qa_score: '3'
topics:
  - topic_aritmetica
  - topic_algebra
...
> Find all pairs of positive integers $(a, b)$ such that $(a+1)(b+1)$ is a multiple of $ab + 1$.
