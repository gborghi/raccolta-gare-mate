...
fase: '2'
quesito: '1'
summary: Find digit sum a+b+c from a long multiplication
qa_score: '4'
topics:
  - topic_aritmetica
methods:
...
> In the following multiplication, $a$, $b$, and $c$ are digits:
> $$\begin{array}{r} 1\;a\;b \\ \times\quad b\;3 \\ \hline * * * \\ * * * \\ \hline 1\;c\;c\;0\;1 \end{array}$$
> Find $a + b + c$.
