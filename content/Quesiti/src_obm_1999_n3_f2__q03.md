...
fase: '2'
quesito: '3'
summary: 'Largest n for rearrangement of (3,6,9,12) making an expression an integer'
qa_score: '4'
topics:
  - topic_aritmetica
  - topic_algebra
...
> Determine the largest integer $n$ for which there exists a rearrangement $(a, b, c, d)$ of $(3, 6, 9, 12)$ such that
> $$\sqrt[4]{a\sqrt[3]{b\sqrt{c^{\,d}}}}$$
