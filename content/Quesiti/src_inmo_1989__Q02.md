...
quesito: '2'
summary: 'Roots of x^3+ax^2+bx+c cannot all be rational given a,b,c real not all zero'
qa_score: '4'
topics:
  - topic_algebra
  - topic_aritmetica
...
> Let $a, b, c$ be real numbers, not all zero. Prove that the roots of the polynomial $x^3 + ax^2 + bx + c = 0$ cannot all be rational.
