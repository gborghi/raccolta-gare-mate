---
title: Olimpíada Brasileira de Matemática 2005 — Nível 2 — Fase 1 — Quesito 14
tipo: quesito
lang: en
quesito_id: quesito_src_obm_2005_n2_f1__Q14
...
fase: '1'
quesito: '14'
summary: 'Integers O,B,M with three product/sum equations; find O+B+M'
qa_score: '4'
answer: B
topics:
  - topic_algebra
...
*Integers O,B,M with three product/sum equations; find O+B+M*

> The letters $O$, $B$ and $M$ represent integers. If $O\times B\times M=240$, $O\times B+M=46$ and $O+B\times M=64$, what is the value of $O+B+M$?
> A) $19$ \quad B) $20$ \quad C) $21$ \quad D) $24$ \quad E) $36$
