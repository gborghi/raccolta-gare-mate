---
title: Olimpiade Matematica Polacca 2000 — Round 2 — Quesito 5
tipo: quesito
quesito_id: quesito_src_pol_2000_r2__Q05
...
quesito: '5'
summary: >-
  Decide whether there is a function f: N -> N such that f(f(n)) = 2n for all
  natural n.
qa_score: '5'
topics:
  - topic_funzionali
...
> Prove or disprove that there is a function $f : \mathbb{N} \to \mathbb{N}$ such that
> $$f(f(n)) = 2n \quad \text{for all } n \in \mathbb{N}.$$
