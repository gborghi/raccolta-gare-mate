...
quesito: '1'
summary: Natural number pairs where (x+1)/y and (y+1)/x are natural
qa_score: '3'
topics:
  - topic_aritmetica
methods:
...
> Find all pairs $(x, y)$ of natural numbers such that the numbers $\frac{x+1}{y}$ and $\frac{y+1}{x}$ are natural.
