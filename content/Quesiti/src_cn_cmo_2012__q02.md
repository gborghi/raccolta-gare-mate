...
quesito: '2'
summary: >-
  On a p x p matrix filled with 1..p^2, add/subtract 1 along whole rows or
  columns; count matrices reducible to all zeros.
qa_score: '2'
answer: $2(p!)^2$
topics:
  - topic_combinatoria
