...
quesito: '1'
summary: >-
  Geometric stability: a sequence with bounded increments x_{n+1}-q x_n in
  [0,epsilon], expressed via telescoping, then approximated by geometric
  sequences for q<1 and q>1.
qa_score: '3'
topics:
  - topic_algebra
