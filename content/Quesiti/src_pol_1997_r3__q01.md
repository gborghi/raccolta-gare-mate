...
quesito: '1'
summary: 'Recurrence with x_6=144 and x_{n+3}=x_{n+2}(x_{n+1}+x_n); find x_7.'
qa_score: '5'
topics:
  - topic_algebra
  - topic_aritmetica
...
> Positive integers $x_1, x_2, \ldots, x_7$ satisfy $x_{n+3} = x_{n+2}(x_{n+1} + x_n)$ for $n = 1, 2, 3, 4$. If $x_6 = 144$, find $x_7$.
