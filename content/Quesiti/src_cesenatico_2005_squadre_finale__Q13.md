...
> fuoco.
> Una sera Al Jabr sfida il nostro eroe a trovare quante soluzioni reali, comprese tra 1 e 100 (estremi inclusi)
> ha l’equazione
> [x2]+[x]2 = 2x[x].
> Qual è la risposta esatta?
> [Il simbolo [x] indica la parte intera di x, cioè il più grande intero n tale che n ≤x]
