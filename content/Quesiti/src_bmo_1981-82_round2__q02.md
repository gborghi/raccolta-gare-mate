...
quesito: '2'
summary: Sequence of primes; prove 5 never appears
qa_score: '3'
topics:
  - topic_aritmetica
methods:
...
> The sequence $p_1, p_2, \ldots$ is defined as follows:
> 
> $p_1 = 2$, and for $n \geq 2$, $p_n$ is the largest prime divisor of
