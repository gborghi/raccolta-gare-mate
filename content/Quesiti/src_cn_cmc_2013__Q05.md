...
quesito: '5'
summary: 'Maximum of ab for linear function with bounded values on [0,1]'
qa_score: '5'
answer: '\frac{1}{4}'
topics:
  - topic_algebra
...
> Let $a$, $b$ be real numbers, and $f(x) = ax + b$ satisfies $|f(x)| \le 1$ for any $x \in [0, 1]$. Then the maximum of $ab$ is $\underline{\qquad}$.
