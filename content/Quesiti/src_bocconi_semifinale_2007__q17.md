...
quesito: '17'
summary: Rapporto AX/XY in triangolo con punto su ceviana
qa_score: '3'
...
> Al recente Festival della Matematica di Roma, il famoso pittore Mathart ha esposto una sua opera di forma triangolare (vedi la figura, che però non rispetta le proporzioni). A visitarla c'era il giovane $X$ che, incuriosito, gli chiedeva come mai il rapporto tra le misure dei lati $AX$ e $XY$. Mathart si limitava a rispondere che il punto $X$ si trovava sulla figura in modo tale che il rapporto $\frac{AX}{XY}$ fosse uguale a quello di 12 a 49.
> 
