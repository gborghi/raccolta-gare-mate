...
quesito: '3'
summary: >-
  A confined professor wants substitute Perrine to reconstruct the seating
  arrangement of n pupils; find the minimal number of questions needed under
  several allowed question types, with adaptive answers, errors, and lying.
qa_score: '3'
topics:
  - topic_combinatoria
  - topic_logica
