...
quesito: '6'
summary: >-
  Collocare 5,6,7,9 sui vertici liberi della stella (con il 3 fissato) cosi che
  le cinque somme sui segmenti siano cinque numeri consecutivi.
qa_score: '3'
answer: >-
  2 soluzioni (es. con 3 in alto: 5 e 6 in alto ai lati, 7 e 9 in basso); le
  cinque somme sono cinque numeri consecutivi
topics:
  - topic_aritmetica
  - topic_combinatoria
methods:
