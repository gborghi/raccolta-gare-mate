...
quesito: '11'
summary: 'Convex quadrilateral ABCD with AD=CD, BD=BC and given angles; find angle BAD.'
qa_score: '3'
topics:
...
> In convex quadrilateral $ABCD$, we have $AD = CD$, $BD = BC$, $\angle ADC = 168^\circ$, and $\angle ABC = 66^\circ$. Find $\angle BAD$.
