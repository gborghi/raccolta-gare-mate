...
quesito: '13'
summary: Perimetro del triangolo isoscele ABC con BD=6 e area AEFD=6.
qa_score: '3'
answer: '16 \text{ cm}'
topics:
...
> Nel triangolo $ABC$, $AB = AC$ sono uguali e $D$, $E$, $F$ sono punti dei rispettivi lati. Il lato $BD$ è lungo $6$ cm e l'area del quadrilatero $AEFD$ è $6\ \text{cm}^2$.
> 
