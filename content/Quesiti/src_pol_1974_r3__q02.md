...
quesito: '2'
summary: >-
  A salmon passes two waterfalls each minute with independent probabilities p
  and q; compute the probability it did not pass the first in n minutes given it
  passed neither in that time.
qa_score: '5'
topics:
  - topic_probabilita
methods:
