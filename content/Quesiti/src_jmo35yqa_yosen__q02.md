...
quesito: '2'
summary: >-
  Count quadruples (a,b,c,d) of positive integers, abcd=2025, ab,bc,cd,da all
  squares
answer: '44'
topics:
  - topic_aritmetica
...
> How many quadruples $(a,b,c,d)$ of positive integers satisfy $abcd = 2025$ such that $ab$, $bc$, $cd$, $da$ are all perfect squares?
