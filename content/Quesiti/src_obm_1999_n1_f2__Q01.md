...
fase: '2'
quesito: '1'
summary: Remove 10 digits from a long number to maximize the remaining value
qa_score: '3'
answer: '5512345512345'
topics:
  - topic_aritmetica
  - topic_combinatoria
methods:
...
> Remove 10 digits from the number $12345123451234512345$ so that the remaining number is as large as possible.
