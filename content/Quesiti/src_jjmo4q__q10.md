...
quesito: '10'
summary: >-
  Find all integer solutions of x²+xy+y²+3x+3y+6=0 with x=1 excluded; then all
  integer pairs
qa_score: '4'
topics:
  - topic_algebra
...
> $$x^2 + xy + y^2 + 3x + 3y + 6 = 0. \quad (*)$$
> (1) Find all pairs of integers $(x, y)$ satisfying $(*)$ with $x = 1$.
> 
