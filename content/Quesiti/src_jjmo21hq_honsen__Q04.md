...
quesito: '4'
summary: 'Find all positive rational triples making a+c/b, b+a/c, c+b/a integers'
qa_score: '3'
topics:
  - topic_aritmetica
  - topic_algebra
...
> Find all triples of positive rational numbers $(a, b, c)$ such that
> $$a + \frac{c}{b}, \quad b + \frac{a}{c}, \quad c + \frac{b}{a}$$
> are all integers.
