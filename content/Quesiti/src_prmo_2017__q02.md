...
quesito: '2'
summary: 'Find floor(a+b) given two radical equations in positive reals a,b'
qa_score: '4'
topics:
  - topic_algebra
methods:
...
> Suppose $a, b$ are positive real numbers such that $a\sqrt{a} + b\sqrt{b} = 183$, $a\sqrt{b} + b\sqrt{a} = 182$. Find $\lfloor(a + b)\rfloor$.
