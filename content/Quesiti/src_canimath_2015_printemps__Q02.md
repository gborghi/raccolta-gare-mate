...
stagione: printemps
quesito: '2'
summary: Right triangle ABC; find point(s) P on perimeter with PA+PB=PC
qa_score: '4'
topics:
...
> Let $ABC$ be a right triangle at $A$. Determine the point(s) $P$ on the perimeter of $ABC$ such that $PA + PB = PC$.
