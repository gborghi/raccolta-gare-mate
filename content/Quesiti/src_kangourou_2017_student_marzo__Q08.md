...
quesito: '8'
summary: Quadrante privo di punti del grafico di f
answer: C
topics:
...
# Kangourou 2017 Student - Gara 16 marzo — Quesito 8

*Quadrante privo di punti del grafico di f*

> C’è un quadrante che non contiene punti del grafico della 
> funzione f definita da f (x) = -3,5 x + 7 ? 
> A) Sì, il I.	
> B) Sì, il II.	
> C) Sì, il III.	
> D) Sì, il IV.	
