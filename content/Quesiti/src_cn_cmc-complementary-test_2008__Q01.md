---
title: China Mathematical Competition (Complementary Test) 2008 — Quesito 1
tipo: quesito
quesito_id: quesito_src_cn_cmc-complementary-test_2008__Q01
...
quesito: '1'
summary: >-
  Convex quadrilateral, minimizing f(P)=PA*BC+PD*CA+PC*AB; concyclicity at the
  minimum and a numeric minimum.
qa_score: '2'
answer: '$f(P)_{\min} = \sqrt{10}$'
topics:
...
> (2) Suppose that point $E$ is on the arc $\overset{\frown}{AB}$ of the circumscribed circle $O$ of $\triangle ABC$, satisfying
