...
fase: '2'
quesito: '2'
summary: Find common prime divisors of all terms of sequence a·2017^n + b·2016^n
qa_score: '3'
topics:
  - topic_aritmetica
methods:
...
> Fix positive integers $a$ and $b$. Find the set of all prime divisors that are common to all terms of the sequence
