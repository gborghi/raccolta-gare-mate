...
quesito: '2'
summary: Find positive integer pairs making both k^2+4m and m^2+5k perfect squares.
qa_score: '4'
topics:
  - topic_aritmetica
methods:
...
> Find all pairs $(k,m)$ of positive integers for which $k^2+4m$ and $m^2+5k$ are both perfect squares.
