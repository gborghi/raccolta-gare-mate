...
quesito: '9'
summary: >-
  Integer-coefficient polynomial with remainder 990x - 889 modulo x^2-12x+11;
  prove no integer roots
qa_score: '4'
topics:
  - topic_algebra
  - topic_aritmetica
...
> A polynomial with integer coefficients, when divided by $x^2 - 12x + 11$, gives the remainder $990x - 889$. Prove that this polynomial has no integer roots.
