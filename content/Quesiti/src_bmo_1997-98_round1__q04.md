...
quesito: '4'
summary: Show unique positive-integer sequence satisfies given recurrence
qa_score: '5'
topics:
  - topic_aritmetica
  - topic_algebra
...
> $$a_1 = 1, \quad a_2 = 2, \quad a_4 = 12,$$
> $$a_{n+1}a_{n-1} = a_n^2 \pm 1 \quad \text{for} \quad n = 2, 3, 4, \ldots.$$
