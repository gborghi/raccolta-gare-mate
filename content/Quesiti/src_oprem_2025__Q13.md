---
title: Olympiades Nationales de Mathématiques (Première) 2025 — Quesito 13
tipo: quesito
quesito_id: quesito_src_oprem_2025__Q13
...
quesito: '13'
summary: >-
  Exercise 3 intro: prove 1+...+m=m(m+1)/2 by reversal, derive shifted-sum
  formula, and the examples 6, 7, 204
qa_score: '3'
answer: 6 has balance 2; 7 is not balanced; 204 has balance 84
topics:
  - topic_aritmetica
  - topic_algebra
methods:
...
> one computes $S + S = 3 \times 4$ and hence $S = 6$.
> 
...
> 
> For example, 35 is a balanced number, since $1 + 2 + 3 + 4 + \cdots + 34 = 595$ and $(35+1) + (35+2) + \cdots + (35+14) = 595$. The balance of 35 is 14.
> 
> **3. Some examples**
> 
