...
quesito: '1'
summary: 'Symmetric product inequality true only for n=3,5'
topics:
...
> Prove that the following statement is true for $n = 3$ and $n = 5$, and that it is false for every other natural number $n > 2$:
> 
