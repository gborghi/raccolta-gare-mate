...
quesito: '2'
summary: Find integer roots of cubic with parameter n
qa_score: '5'
topics:
  - topic_algebra
  - topic_aritmetica
...
> Suppose $n \ge 0$ is an integer and all the roots of $x^3 + ax + 4 - (2 \times 2016^n) = 0$ are integers. Find all possible values of $a$.
