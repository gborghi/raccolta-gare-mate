---
title: Concours Général des Lycées 2009 — Matematica — Quesito 1
tipo: quesito
quesito_id: quesito_src_cgen_2009__Q01
...
quesito: '1'
summary: >-
  Functional equation f(2x)=2f(x)^2-1 with f(0)=1; show f(x)=cos(x*sqrt(2a))
  using trig substitution and limits.
qa_score: '5'
topics:
  - topic_funzionali
  - topic_trigonometria
