...
quesito: '4'
summary: 'Candy-eating algorithm: prove last candy eaten is red'
qa_score: '5'
topics:
  - topic_probabilita
  - topic_combinatoria
...
> 
> a) If sweets remain, he picks one at random, notes its colour, and goes to step b).
> b) If sweets remain, he picks one at random and notes its colour:
