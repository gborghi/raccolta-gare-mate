...
quesito: '22'
summary: 'Exercise 3, Q3: condition on b for a 2 x b grid to be pavable'
qa_score: '2'
topics:
  - topic_combinatoria
...
> Exercise 3 - (3) One supposes $a = 2$. Under which necessary and sufficient condition on $b$ is the grid of size $2 \times b$ pavable?
