...
fase: '1'
quesito: '4'
summary: 'Roots of quadratic: find a-b given product and sum conditions'
qa_score: '3'
answer: D
topics:
  - topic_algebra
...
> Given $a \neq b$, $b \neq 0$, and knowing that the roots of the equation $x^2 + ax + b = 0$ are exactly $a$ and $b$, then $a - b$ equals:
> 
