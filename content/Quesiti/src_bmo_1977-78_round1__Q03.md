...
quesito: '3'
summary: Show sequence u_n has one and only one solution with u_1 < u_2
qa_score: '4'
topics:
  - topic_algebra
  - topic_aritmetica
...
> Show that there is one and only one sequence $\{u_n\}$ of integers such that $u_1 < u_2$ and
