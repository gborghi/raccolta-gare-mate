...
> Che < MSK0/> sia un quadrilaterale convex. I punti intermedi di $AB$, $BC$, $CD$ e $DA$ sono rispettivamente $P$, $Q$, $R$ e $S$. Dato che il quadrilaterale $PQRS$ ha area 1, dimostrare che l'area del quadrilaterale $ABCD$ è 2.
