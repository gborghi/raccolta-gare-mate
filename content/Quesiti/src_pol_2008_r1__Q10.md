...
quesito: '10'
summary: >-
  Prime p; sequence a_{n+1}=a_n+p*floor(p-th root of a_n); show some term is a
  p-th power of an integer.
qa_score: '5'
topics:
  - topic_aritmetica
methods:
...
> Show that there is a term in this sequence which is the $p$-th power of an integer.
