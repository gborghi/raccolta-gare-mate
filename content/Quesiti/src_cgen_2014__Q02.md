...
quesito: '2'
summary: >-
  Dice/coin game 'Vite, pile': each of k players flips a fair coin until heads
  (score = number of flips). Find probability a given player wins, probability
  of a unique winner (and limit as n to infinity), and expected number of
  winners (and limit).
qa_score: '3'
topics:
  - topic_probabilita
