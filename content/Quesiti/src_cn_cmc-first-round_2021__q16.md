...
quesito: '16'
summary: 'A1-5: sequence a_1=1, a_n=1/(4a_{n-1})+1/n; find a_100.'
qa_score: '2'
answer: '\dfrac{101}{200}'
topics:
  - topic_algebra
methods:
  - method_induzione
...
> [Test Paper A1, Problem 5] Let sequence $\{a_n\}$ satisfy $a_1=1$, $a_n=\dfrac{1}{4a_{n-1}}+\dfrac{1}{n}\ (n\ge 2)$. Then the value of $a_{100}$ is ______.
