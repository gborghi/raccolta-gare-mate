...
quesito: '5'
summary: >-
  Find all prime triples (p,q,r) for which pq+qr+rp and p^3+q^3+r^3-2pqr are
  divisible by p+q+r.
qa_score: '5'
topics:
  - topic_aritmetica
...
> Find all triples $(p, q, r)$ of prime numbers for which
> $$pq + qr + rp \quad \text{and} \quad p^3 + q^3 + r^3 - 2pqr$$
> are divisible by $p + q + r$.
