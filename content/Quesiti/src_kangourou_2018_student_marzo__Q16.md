...
quesito: '16'
summary: Valore di p+q+r+s+t+u dati i tre punti medi
answer: D
topics:
...
> Nel piano dotato di un sistema di coordinate, i vertici di un triangolo hanno coor­
> dinate (p, q), (r, s) e (t, u). Se i tre punti medi dei lati hanno coordinate (-2, 1), (2, -1) 
> e (3, 2), quanto vale
> p + q + r + s + t + u ?
> A) 2	
> 	
