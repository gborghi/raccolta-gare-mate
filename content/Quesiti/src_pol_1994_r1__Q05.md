...
quesito: '5'
summary: 'If a cubic has three distinct real roots, a related cubic does too'
topics:
  - topic_algebra
methods:
  - method_casework
...
> Prove that if the polynomial $x^3 + ax^2 + bx + c$ has three distinct real roots, then so does the polynomial
