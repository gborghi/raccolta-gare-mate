...
fase: '3'
quesito: '4'
summary: 'Do there exist 2011 positive integers with gcd(a_i,a_j)=a_j-a_i for all i<j?'
qa_score: '3'
topics:
  - topic_aritmetica
methods:
...
> Do there exist 2011 positive integers $a_1 < a_2 < \cdots < a_{2011}$ such that, for all $1 \le i < j \le 2011$,
> $$\gcd(a_i,\, a_j) = a_j - a_i\,?$$
