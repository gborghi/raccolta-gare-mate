...
quesito: '26'
summary: 'Quanti valori di A con B=2A+1, C=2B+1 e cifre palindrome'
answer: C
topics:
  - topic_aritmetica
methods:
...
> Di tre interi positivi A, B e C si sa che ognuno ha tre cifre significative e che per 
> ciascuno di essi la prima e l’ultima cifra coincidono. Si sa inoltre che 
> B = 2A + 1   e   C = 2B + 1. 
> Quanti valori diversi può assumere A? 
> A) 0	
> 	
> B) 1	
> 	
