...
quesito: '1'
summary: Count integer 4-tuples with strict inequalities and bounded differences
qa_score: '4'
answer: '7'
topics:
  - topic_combinatoria
...
> Find the number of quadruples $(a, b, c, d)$ of integers from 1 to 9 satisfying $0 < b - a < c - b < d - c$.
