...
fase: '3'
quesito: '4'
summary: 'Count 3-element subsets {a,b,c} of {1..100} with b arithmetic mean of a and c'
qa_score: '4'
topics:
  - topic_combinatoria
  - topic_aritmetica
...
> How many three-element subsets $\{a, b, c\}$ of $\{1, 2, 3, \ldots, 100\}$ are such that $b$ is the arithmetic mean of $a$ and $c$ (with $a < b < c$)?
