---
title: IMO 1977 (XIX International Mathematical Olympiad) — Quesito 3
tipo: quesito
lang: it
quesito_id: quesito_src_imho_1977__Q03
...
quesito: '3'
summary: Indecomposable numbers in set $V_k$; prove $p = m$
qa_score: '5'
topics:
  - topic_aritmetica
methods:
...
*Indecomposable numbers in set $V_k$; prove $p = m$*
...
*Indecomposable numbers in set $V_k$; proofs $p = m$*
