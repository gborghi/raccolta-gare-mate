...
fase: '2'
quesito: '2'
summary: Count ways to shade one cell per row and column in 4x4 grid
qa_score: '4'
topics:
  - topic_combinatoria
methods:
...
> In how many ways can we shade four cells of a $4 \times 4$ grid so that each row and each column contains exactly one shaded cell?
