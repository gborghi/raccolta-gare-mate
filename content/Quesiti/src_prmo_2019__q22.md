...
quesito: '22'
summary: Greatest integer not exceeding sum of 1/sqrt(k) up to 1500
qa_score: '4'
topics:
  - topic_aritmetica
  - topic_algebra
...
> What is the greatest integer not exceeding the sum $\displaystyle\sum_{k=1}^{1500} \frac{1}{\sqrt{k}}$?
