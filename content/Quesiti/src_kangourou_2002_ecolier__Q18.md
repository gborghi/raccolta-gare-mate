...
> Roberta costruisce un tunnel utilizzando solo 
> cubetti identici fra loro (fig. 1). Quando si è 
> stancata di quella costruzione, smonta il tunnel e 
> costruisce una piramide (fig. 2). Quanti cubetti 
> usati nel tunnel non sono stati utilizzati per 
