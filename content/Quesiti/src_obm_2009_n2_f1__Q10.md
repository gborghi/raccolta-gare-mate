...
fase: '1'
quesito: '10'
summary: Isosceles chains from common vertex; find angle beta given alpha=18°
qa_score: '3'
answer: B
topics:
...
> In the figure below, $\alpha = 18^{\circ}$ and $AB = AC = AD = AE$. The value of the angle $\beta$ is:
> 
