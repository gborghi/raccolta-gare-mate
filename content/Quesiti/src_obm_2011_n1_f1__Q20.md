...
fase: '1'
quesito: '20'
summary: Minimum number of notes changing hands so three girls have equal amounts
qa_score: '2'
topics:
  - topic_aritmetica
  - topic_combinatoria
...
# Olimpíada Brasileira de Matemática 2011 — Nível 1 — Fase 1 — Quesito 20

*Minimum number of notes changing hands so three girls have equal amounts*

> Esmeralda has 11 notes of two reais, Rosa has 7 notes of five reais, and Nelly has 3 notes of ten reais. What is the smallest possible number of the total notes that must change hands so that all the girls end up with the same amount?
> 
