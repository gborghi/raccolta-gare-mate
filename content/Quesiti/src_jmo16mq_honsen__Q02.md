...
quesito: '2'
summary: Find all integers k with infinitely many integer solutions to the equation
qa_score: '3'
topics:
  - topic_aritmetica
methods:
...
> Find all integers $k$ for which there exist infinitely many triples of integers $(a, b, c)$ satisfying
> $$(a^2 - k)(b^2 - k) = c^2 - k.$$
