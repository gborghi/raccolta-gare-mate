...
quesito: '11'
summary: >-
  Non-negative reals S=a+2b+3c, T=a+b^2+c^3: find min of T-S and max of T given
  S=4
qa_score: '3'
answer: (1) $-3$; (2) $4$
topics:
...
> (Test Paper B1, Problem 1) Let $a$, $b$, $c$ be non-negative real numbers. Denote $S = a + 2b + 3c$, $T = a + b^2 + c^3$.
