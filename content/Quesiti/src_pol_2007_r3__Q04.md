...
quesito: '4'
summary: >-
  Count the number of possible values of the product km for integers with n^2 <=
  k <= m <= (n+1)^2.
qa_score: '5'
topics:
  - topic_aritmetica
...
> Given an integer $n \ge 1$, find the number of possible values of the product $km$, where $k$ and $m$ are integers with $n^2 \le k \le m \le (n+1)^2$.
