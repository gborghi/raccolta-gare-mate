---
title: Olimpíada Brasileira de Matemática 2004 — Nível 1 — Fase 2 — Quesito 8
tipo: quesito
quesito_id: quesito_src_obm_2004_n1_f2__Q08
...
fase: '2'
quesito: '8'
summary: Area and perimeter of gray squares in grid; maximize area with fixed perimeter
qa_score: '3'
topics:
...
*Area and perimeter of gray squares in grid; maximize area with fixed perimeter*

> In the grid below, each small square has area $1\,\text{cm}^2$.
> 
> (a) What are the area and perimeter of the figure formed by the gray squares?
> 
