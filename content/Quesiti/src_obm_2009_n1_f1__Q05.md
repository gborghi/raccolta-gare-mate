...
fase: '1'
quesito: '5'
summary: Circulant 4x4 determinant equals f(1)f(i)f(-1)f(-i)
qa_score: '5'
topics:
  - topic_algebra
methods:
...
> Given the real numbers $a,b,c,d$, consider the matrix
> $$A=\begin{pmatrix}a&b&c&d\\d&a&b&c\\c&d&a&b\\b&c&d&a\end{pmatrix}.$$
> If $f(x)=a+bx+cx^2+dx^3$, prove that
