...
fase: '1'
quesito: '5'
summary: 'Magic square with 14, x, 26, 13; find x'
qa_score: '3'
answer: E
topics:
  - topic_algebra
...
> In a magic square, the sum of the numbers in each row, column, or diagonal is always the same. In the magic square below, the value of $x$ is:
> 
