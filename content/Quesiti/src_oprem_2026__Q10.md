...
quesito: '10'
summary: 'Exercise 2, Q4: prove pi_n <= n and find equality cases'
qa_score: '2'
topics:
  - topic_aritmetica
skills:
...
> Exercise 2 - (4) Demonstrate that for every natural integer $n$, $\pi_n \le n$. For which integer(s) $n$ does one have $\pi_n = n$?
