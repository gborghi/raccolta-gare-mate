...
quesito: '1'
summary: Quartic with four positive roots implies inequalities on coefficients
qa_score: '5'
topics:
  - topic_algebra
...
> If the equation $x^4 + px^3 + qx^2 + rx + s = 0$ has four positive real roots, prove that
> 
> (a) $pr - 16s \ge 0$
> 
> (b) $q^2 - 36s \ge 0$
