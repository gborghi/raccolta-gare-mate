...
quesito: '20'
summary: 'Maximum value of y given 1/x + 1/y = 1/20 with x, y positive integers'
qa_score: '4'
answer: D
topics:
  - topic_algebra
...
> Let $x$ and $y$ be positive integers such that $\frac{1}{x} + \frac{1}{y} = \frac{1}{20}$. What is the maximum possible value of $y$?
>
> - **(A)** $40$
> - **(B)** $60$
> - **(C)** $240$
