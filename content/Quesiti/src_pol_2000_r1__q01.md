...
quesito: '1'
summary: Prove n divides the sum of cubes of all naturals less than n and coprime to n.
qa_score: '4'
topics:
  - topic_aritmetica
methods:
...
> Prove that, for every integer $n \ge 3$, the sum of the cubes of all natural numbers less than $n$ and coprime with $n$ is divisible by $n$.
