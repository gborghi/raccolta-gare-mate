...
quesito: '1'
summary: >-
  Find all degree-5 real polynomials with divisibility conditions involving
  (x-1)^3 and (x+1)^3.
qa_score: '5'
topics:
  - topic_algebra
...
> Find all real polynomials $P(x)$ of degree 5 such that $(x-1)^3 \mid P(x)+1$ and $(x+1)^3 \mid P(x)-1$.
