...
quesito: '6'
summary: >-
  Smallest n such that 14n, 16n, 18n, 20n all have equal number of positive
  divisors
qa_score: '4'
topics:
  - topic_aritmetica
...
> Find the smallest positive integer $n$ such that $14n$, $16n$, $18n$, and $20n$ all have the same number of positive divisors.
