...
quesito: '29'
summary: 'Positive integers a,b,c with ab/(a-b)=c; find largest a+b+c not exceeding 99'
qa_score: '3'
topics:
  - topic_aritmetica
  - topic_algebra
...
> Positive integers $a, b, c$ satisfy $\dfrac{ab}{a - b} = c$. What is the largest possible value of $a + b + c$ not exceeding 99?
