...
fase: '2'
quesito: '9'
summary: 'Fibonacci sequence: find all positive integer pairs (m,n) with F_m·F_n=mn'
qa_score: '3'
topics:
  - topic_aritmetica
  - topic_combinatoria
...
> The sequence $F_n$ is defined by $F_1 = F_2 = 1$ and $F_n = F_{n-1} + F_{n-2}$ for $n \ge 3$. Find all pairs of positive integers $(m, n)$ such that $F_m \cdot F_n = mn$.
