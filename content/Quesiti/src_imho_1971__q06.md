...
quesito: '6'
summary: Square matrix with row/column sums >= n implies sum of all elements >= n^2/2
qa_score: '5'
topics:
  - topic_algebra
  - topic_combinatoria
...
**Metodo:** [[method_doppio_conteggio|Doppio conteggio]], [[method_disuguaglianze|Disuguaglianze]], [[method_casework|Casework]]
