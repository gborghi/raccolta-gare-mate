...
quesito: '2'
summary: 'Triangolo italiano: colorare i nove triangolini con regole'
qa_score: '4'
answer: >-
  Pur con 'l'aiuto', il quesito ammette diverse soluzioni; una di queste prevede
  una 'V' nel livello intermedio e (nel livello inferiore, da sinistra a
  destra): B – V – R – V – B.
topics:
  - topic_combinatoria
  - topic_logica
...
> Bisogna colorare i nove piccoli triangoli, che compongono il triangolo grande, in bianco (B) - rosso (R)- verde (V) in modo però da soddisfare le seguenti regole:
> - due triangoli con una lato in comune non possono avere lo stesso colore;
> - alla fine devono esserci 3 triangoli bianchi, 3 verdi, 3 rossi.
> 
