...
quesito: '9'
summary: >-
  Among any 12 consecutive integers one cannot be written as a sum of ten fourth
  powers.
qa_score: '4'
topics:
  - topic_aritmetica
...
> Prove that among any $12$ consecutive integers there is one that cannot be written as a sum of ten fourth powers.
