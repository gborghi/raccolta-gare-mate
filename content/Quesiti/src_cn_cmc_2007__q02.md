...
quesito: '2'
summary: Range of a satisfying absolute value inequality for all real x
qa_score: '4'
answer: A
topics:
  - topic_algebra
...
> Suppose real number $a$ satisfies: for any $x \in \mathbb{R}$, $|2x - a| + |3x - 2a| \ge a^2$. Then $a$ lies in $($\quad$)$.
> 
