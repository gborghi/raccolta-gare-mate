...
fase: '1'
quesito: '19'
summary: Number of real solutions of x|x|+y|y|=1 and floor(x)+floor(y)=1
qa_score: '4'
topics:
  - topic_algebra
  - topic_funzionali
...
> What is the number of real solutions of the system
> $$x \cdot |x| + y \cdot |y| = 1 \quad \text{and} \quad \lfloor x \rfloor + \lfloor y \rfloor = 1,$$
