...
quesito: '1'
summary: >-
  Find all positive integers z so that 1/x + 1/y = 1/z has exactly 2011
  solutions
qa_score: '4'
answer: '$z = p^{4021}$ for any prime $p$'
topics:
  - topic_aritmetica
  - topic_combinatoria
methods:
...
> Find all positive integers $z$ such that the equation $\frac{1}{x} + \frac{1}{y} = \frac{1}{z}$ has exactly $2011$ positive integer solutions $(x, y)$ with $x \leq y$.
