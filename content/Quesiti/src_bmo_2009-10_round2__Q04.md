...
quesito: '4'
summary: 'Prove inequality for positive reals x, y, z'
qa_score: '2'
topics:
...
> $$\left(\frac{x+y}{z}\right)^2 + \left(\frac{y+z}{x}\right)^2 + \left(\frac{z+x}{y}\right)^2 \ge 3(x+y+z)\left(\frac{1}{x}+\frac{1}{y}+\frac{1}{z}\right) - 9.$$
