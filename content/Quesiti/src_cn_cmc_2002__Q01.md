...
quesito: '1'
summary: Monotone increasing interval of a logarithmic composite function
qa_score: '3'
answer: A
topics:
  - topic_algebra
...
> The interval on which the function $f(x) = \log_{\frac{1}{2}}(x^2 - 2x - 3)$ is monotone increasing is \quad (\quad).
> 
