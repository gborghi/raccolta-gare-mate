...
quesito: '25'
summary: Valore A+B-C (somme righe e colonne)
answer: B
topics:
  - topic_algebra
skills:
...
> Osserva la figura. Le tre lettere A, B e C rappresentano altrettanti numeri le cui somme, per righe e per
> colonne, sono quelle indicate (a destra per le righe e in
> basso per le colonne). Quanto vale A + B - C ?
> A) 5
> B) 6
> C) 7
> D) 8
