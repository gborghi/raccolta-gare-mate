...
quesito: '3'
summary: Prove lower bound on product of distances from one point to all others
qa_score: '3'
topics:
...
> (50 marks) Let $P_0, P_1, P_2, \ldots, P_n$ be $n + 1$ points on a plane, the minimum distance between each two of them is $d > 0$. Prove
