...
quesito: '2'
summary: >-
  On the Nine Men's Morris board, define a 'mill figure': points and straight
  segments with each segment holding 3 points and each point on 2 segments; find
  minimal point count, connectedness, similarity classes and counting, with a
  generalized variant.
qa_score: '4'
topics:
  - topic_combinatoria
