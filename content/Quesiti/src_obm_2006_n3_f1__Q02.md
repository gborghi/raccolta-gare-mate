...
fase: '1'
quesito: '2'
summary: 'Count distinct sums of pairs of distinct numbers from {1,2,...,2006}.'
qa_score: '2'
answer: D
topics:
  - topic_combinatoria
...
# Olimpíada Brasileira de Matemática 2006 — Nível 3 — Fase 1 — Quesito 2

*Count distinct sums of pairs of distinct numbers from {1,2,...,2006}.*

> How many different results can we obtain by summing pairs of distinct numbers from the set $\{1, 2, \ldots, 2006\}$?
> 
