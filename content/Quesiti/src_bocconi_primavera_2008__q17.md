...
quesito: '17'
summary: Identificare la pila con monete false con una sola pesata
qa_score: '3'
answer: >-
  275 g (la differenza tra il peso effettivo e 275 g assegna il numero di monete
  false e quindi la pila da cui sono state prese)
topics:
  - topic_logica
  - topic_aritmetica
methods:
...
> Avete davanti a voi 10 pile costituite, ciascuna, da 10 monete. Una di queste pile è costituita da monete false (che pesano, ciascuna, 10 monete. Una di queste pile è costituita da monete false (che pesano, ciascuna) 5 g; le altre sono formate da monete vere (che pesano ciascuna) 5 g.
