---
title: China Western Mathematical Olympiad 2013 — Quesito 5
tipo: quesito
lang: en
quesito_id: quesito_src_cn_cwmo_2013__Q05
...
quesito: '5'
summary: Find all positive integers a dividing a^n - n^a by 2^n - n^2
qa_score: '3'
answer: $a = 2$ or $a = 4$
topics:
  - topic_aritmetica
...
*Find all positive integers a dividing a^n - n^a by 2^n - n^2*

> Find all positive integers $a$ such that $(2^n - n^2) \mid (a^n - n^a)$ for all positive integers $n \geq 4$. (posed by Yang Mingliang)
