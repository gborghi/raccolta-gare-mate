...
quesito: '3'
summary: Find tan A given trigonometric identities in triangle
qa_score: '5'
answer: '11'
topics:
  - topic_trigonometria
...
> Suppose in $\triangle ABC$ we have $\sin A = 10\sin B\sin C$, $\cos A = 10\cos B\cos C$. Then $\tan A = \underline{\qquad}$.
