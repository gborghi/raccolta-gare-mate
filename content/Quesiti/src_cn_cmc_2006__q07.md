...
quesito: '7'
summary: Find the range of f(x)=sin^4 x - sin x cos x + cos^4 x
qa_score: '3'
answer: '$\left[0,\, \dfrac{9}{8}\right]$'
topics:
  - topic_trigonometria
...
> Let $f(x) = \sin^4 x - \sin x \cos x + \cos^4 x$. The range of $f(x)$ is ________.
