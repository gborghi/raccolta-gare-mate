...
quesito: '2'
summary: Minimum of symmetric function given linear constraints on positive reals
qa_score: '4'
answer: '\frac{1}{2}'
topics:
...
> Assume that positive numbers $a$, $b$, $c$, $x$, $y$, $z$ satisfy $cy + bz = a$, $az + cx = b$, $bx + ay = c$. Find the minimum value of the function
