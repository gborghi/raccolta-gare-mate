...
quesito: '1'
summary: >-
  Geometric configuration: circles of diameter [AC] and [BC] tangent at C,
  homotheties between three circles, collinearity and radius relation
qa_score: '2'
topics:
...
> 
> In the plane, let $A$, $B$, $C$ be three distinct points such that $B$ does not lie on the segment $[AC]$. Let $\Gamma$ be the circle of diameter $[AC]$, let $\Gamma'$ be the circle of diameter $[BC]$, and let $D$ be the point diametrically opposite to $A$ on $\Gamma$. One supposes that the circles $\Gamma$ and $\Gamma'$ are tangent at $C$.
> 
> 1. Justify that the lines $\Delta = (CF)$ and $(BD)$ are parallel. Denote by $G$ their point of intersection.
> 
> 2. Show that there exists a homothety with center $C$ that transforms $\gamma$ into $\Gamma$, and a homothety with center $F$ that transforms $\Gamma$ into $\gamma'$.
> 
> 3. Determine the centers of the homotheties that transform $\gamma$ into $\gamma'$.
> 
> 4. Let $AB = (\Delta)$. Show that the points $A$, $I$, $D$ are aligned on a line orthogonal to $(GD)$.
> 
> 5. Show that $AB = GD$.
> 
> 6. Express the radius $r'$ of $\gamma'$ as a function of the radii $R$ and $r$ of $\Gamma$ and $\gamma$.
> 
