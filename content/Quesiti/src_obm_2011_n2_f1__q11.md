...
fase: '1'
quesito: '11'
summary: Sum of digits of the number subtracted to turn 13/14 into 14/15
qa_score: '3'
topics:
  - topic_algebra
  - topic_aritmetica
...
> Subtracting a same number from the numerator and the denominator of the fraction $\dfrac{13}{14}$, we obtain the fraction $\dfrac{14}{15}$. The sum of the digits of this number is:
> 
