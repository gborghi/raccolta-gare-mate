...
fase: '2'
quesito: '8'
summary: Factor polynomial; find all integer pairs satisfying quadratic equation
qa_score: '3'
topics:
  - topic_algebra
  - topic_aritmetica
...
> (a) Factor the expression $x^2 - 9xy + 8y^2$.
> 
> (b) Determine all pairs of integers $(x, y)$ such that $9xy - x^2 - 8y^2 = 2005$.
