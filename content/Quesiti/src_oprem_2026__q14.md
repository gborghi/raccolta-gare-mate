---
title: Olympiades Nationales de Mathématiques (Première) 2026 — Quesito 14
tipo: quesito
quesito_id: quesito_src_oprem_2026__Q14
...
quesito: '14'
summary: 'Exercise 2, Q8: super primes form increasing sequence, prove pi(s_n)=s_n'
qa_score: '2'
topics:
  - topic_aritmetica
skills:
...
> Exercise 2 - (8) One supposes that there exist infinitely many non-zero super prime natural integers. Suppose one constructs the smallest super prime integers $s_1 < \cdots < s_n$. Show that the smallest super prime $s_n$ verifies $\pi(s_n) = s_n$.
