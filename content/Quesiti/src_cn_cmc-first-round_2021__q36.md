...
quesito: '36'
summary: 'B-3: range of y=sin^2 x+√3 sinx cosx on [π/4,π/2].'
qa_score: '2'
answer: '\left[1,\dfrac{3}{2}\right]'
topics:
  - topic_trigonometria
methods:
...
> [Test Paper B, Problem 3] The range of $y=\sin^2 x+\sqrt{3}\sin x\cos x$ when $\dfrac{\pi}{4}\le x\le\dfrac{\pi}{2}$ is ______.
