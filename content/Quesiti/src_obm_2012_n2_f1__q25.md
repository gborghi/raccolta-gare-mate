...
quesito: '25'
summary: >-
  Largest subset of {1..25} with no two elements whose product is a perfect
  square
qa_score: '2'
topics:
  - topic_combinatoria
...
> How many elements has the largest subset of $\{1, 2, 3, \ldots, 25\}$ that does not contain two distinct numbers whose product is a perfect square?
> 
