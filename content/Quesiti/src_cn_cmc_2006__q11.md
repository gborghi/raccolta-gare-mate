...
quesito: '11'
summary: Minimum value of trig-radical function on interval
qa_score: '4'
...
> Given $f(x) = \frac{\sin(\pi x) - \cos(\pi x) + 2}{\sqrt{x}}$ for $\frac{1}{4} \le x \le \frac{5}{4}$, the minimum of $f(x)$ is $\underline{\hspace{2cm}}$.
