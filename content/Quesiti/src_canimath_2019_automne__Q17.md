...
quesito: '17'
summary: >-
  Existence of sequence of strictly positive integers satisfying a_{n+2} =
  a_{n+1} + sqrt(a_n + a_{n+1})
qa_score: '4'
topics:
  - topic_algebra
  - topic_aritmetica
...
> Does there exist a sequence of strictly positive integers $a_0, a_1, \ldots$ such that
