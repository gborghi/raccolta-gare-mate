...
quesito: '6'
summary: Smallest number of edges of a solid polyhedron with one octagonal face
qa_score: '4'
answer: D
topics:
...
> One face of a solid polyhedron is an octagon. What is the smallest possible number of edges the solid could have?
>
> - **(A)** $9$
> - **(B)** $10$
> - **(C)** $12$
