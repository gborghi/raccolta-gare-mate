...
quesito: '4'
summary: Maximize a+b-c+d for real numbers with cosine inequality constraint
qa_score: '3'
answer: '3'
topics:
  - topic_algebra
...
> Let real numbers $a$, $b$, $c$ and $d$ satisfy
> $$f(x) = a\cos x + b\cos 2x + c\cos 3x + d\cos 4x \leq 1$$
