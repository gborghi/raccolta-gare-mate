...
quesito: '1'
summary: Find four primes less than 100 dividing 3^n - 2^n for some n
qa_score: '5'
topics:
  - topic_aritmetica
methods:
...
> Find four prime numbers less than 100 which are factors of $3^n - 2^n$ for some positive integer $n$.
