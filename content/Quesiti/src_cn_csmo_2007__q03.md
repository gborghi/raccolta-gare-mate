...
quesito: '3'
summary: >-
  Count integers a for which a quadratic has even roots with absolute value less
  than 1000
qa_score: '2'
topics:
  - topic_algebra
...
> How many integers $a$ satisfy the condition: for each $a$, the equation $x^2 = ax + a + 1$ with respect to $x$ has roots which are even and $|x| < 1000$?
