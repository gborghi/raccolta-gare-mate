...
quesito: '10'
summary: >-
  Find b - d given log relations and a difference condition on positive
  integers.
qa_score: '2'
answer: '93'
topics:
...
> Let $a, b, c, d$ be positive integers and $\log_a b = \frac{3}{2}$, $\log_c d = \frac{5}{4}$. If $a - c = 9$, then $b - d = $ ___.
