...
quesito: '3'
summary: Find all positive integers n with n = phi(n) + 2 phi(phi(n))
qa_score: '5'
topics:
  - topic_aritmetica
methods:
...
> $$n = \phi(n) + 2\phi\big(\phi(n)\big).$$
> Here, $\phi(n)$ denotes the number of integers from $1$ to $n$ that are coprime to $n$.
