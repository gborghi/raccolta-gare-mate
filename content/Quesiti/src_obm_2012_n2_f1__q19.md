...
quesito: '19'
summary: >-
  Sum of values of m so roots of x^2-mx+m+5=0 are legs of a right triangle with
  hypotenuse 5
qa_score: '2'
topics:
  - topic_algebra
...
> On calculating the roots of the second-degree equation $x^2 - mx + m + 5 = 0$, Samuca noticed that they are the legs of a right triangle with hypotenuse of length $5$. What is the sum of the possible values of $m$?
> 
