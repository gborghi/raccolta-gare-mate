...
quesito: '4'
summary: 'Count positive integer pairs (m,n) with 7m+3n=10^2004 and m divides n.'
qa_score: '3'
topics:
  - topic_aritmetica
  - topic_algebra
...
> Find the number of pairs $(m, n)$ of positive integers satisfying $7m + 3n = 10^{2004}$, such that $\dfrac{n}{m}$ is an integer.
