...
quesito: '6'
summary: Count integer triples satisfying two equations with bound 80000
qa_score: '3'
answer: '80197'
topics:
  - topic_algebra
...
> Find the number of triples of integers $(a, b, c)$ with $1 \le a, b, c \le 80000$ satisfying both $a + b^2 + c^3 = b(c+1)^2$ and $2b = a + c$.
