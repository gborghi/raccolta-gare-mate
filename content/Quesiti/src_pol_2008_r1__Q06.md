...
quesito: '6'
summary: >-
  Find all real-coefficient polynomials W(x) with W(x^2)W(x^3) = W(x)^5 for all
  real x.
qa_score: '5'
topics:
  - topic_algebra
...
> Find all polynomials $W(x)$ with real coefficients such that $W(x^2) W(x^3) = W(x)^5$ holds for every real number $x$.
