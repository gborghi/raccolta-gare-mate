...
quesito: '4'
summary: Count non-degenerate triangles with vertices in integer-coordinate set
qa_score: '5'
topics:
  - topic_combinatoria
methods:
...
> Find the number of (nondegenerate) triangles whose vertices lie in the set of points $(s, t)$ in the plane with $s, t \in \{0, 1, 2, 3, 4\}$.
