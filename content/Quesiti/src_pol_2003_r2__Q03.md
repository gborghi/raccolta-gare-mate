...
quesito: '3'
summary: >-
  For W(x)=x^4-3x^3+5x^2-9x, find all pairs of distinct integers a,b with
  W(a)=W(b).
qa_score: '5'
topics:
  - topic_algebra
...
> Consider the polynomial $W(x) = x^4 - 3x^3 + 5x^2 - 9x$. Find all pairs of distinct integers $a, b$ satisfying $W(a) = W(b)$.
