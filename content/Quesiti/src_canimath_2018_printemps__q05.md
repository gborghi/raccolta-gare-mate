...
stagione: printemps
quesito: '5'
summary: 'Two points on semicircle of diameter AD with AB=BC=1, find CD'
qa_score: '4'
topics:
...
> On a semicircle of diameter $[AD]$, place two points $B$ and $C$ such that $AB = BC = 1$. Suppose $AD = 3$. Calculate the length $CD$.
