...
quesito: '1'
summary: 'Functional equation for non-negative integers, find f(1982)'
qa_score: '5'
topics:
  - topic_algebra
  - topic_aritmetica
...
> The function $f(n)$ is defined for all non-negative integers $n$ and takes on non-negative integer values. Also, for all $m, n$:
