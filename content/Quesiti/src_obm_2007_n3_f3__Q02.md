...
quesito: '2'
summary: >-
  Count integers c in [-2007,2007] for which x^2+c is a multiple of 2^2007 for
  some integer x
qa_score: '5'
topics:
  - topic_aritmetica
...
> For how many integers $c$, with $-2007 \le c \le 2007$, does there exist an integer $x$ such that $x^2 + c$ is a multiple of $2^{2007}$?
