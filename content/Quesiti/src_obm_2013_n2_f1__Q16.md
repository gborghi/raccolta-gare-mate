...
fase: '1'
quesito: '16'
summary: Largest common divisor of all 9-digit pandigital numbers (digits 1-9)
qa_score: '3'
answer: B
topics:
  - topic_aritmetica
...
> Determine the largest divisor common to \emph{all} 9-digit numbers formed by using each of the digits $1, 2, 3, 4, 5, 6, 7, 8, 9$ exactly once.
> 
