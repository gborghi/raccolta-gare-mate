...
fase: '1'
quesito: '4'
summary: Find positive integers m so polynomial is divisible by given polynomial
qa_score: '5'
topics:
  - topic_algebra
  - topic_aritmetica
...
> Determine all positive integers $m$ for which the polynomial $(x+1)^m + x^m + 1$ is divisible by $(x^2+x+1)^2$.
