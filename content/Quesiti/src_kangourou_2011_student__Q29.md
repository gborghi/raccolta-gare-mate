...
quesito: '29'
summary: Minimo valore ammissibile per n nella griglia 4x5
answer: C
topics:
  - topic_aritmetica
  - topic_combinatoria
...
> In ogni cella di una griglia 4x5 è stato inserito un intero positivo. I numeri inseriti sono a due a due diversi fra loro. Ogni coppia di numeri adiacenti
> (cioè in celle che abbiano un lato comune) ha un divisore comune maggiore di
