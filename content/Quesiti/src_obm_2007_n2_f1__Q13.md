...
fase: '1'
quesito: '13'
summary: Count of 3-digit x with 6x and 7x having the same digit count
qa_score: '4'
answer: A
topics:
  - topic_aritmetica
...
> The quantity of three-digit integers $x$ such that $6x$ and $7x$ have the same quantity of digits is:
> 
