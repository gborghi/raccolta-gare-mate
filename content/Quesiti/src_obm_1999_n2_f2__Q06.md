...
quesito: '6'
summary: >-
  Find all positive integers n for which a 9x10 rectangle can be tiled using 1xn
  pieces.
qa_score: '5'
topics:
  - topic_combinatoria
...
> Determine all positive integers $n$ for which it is possible to assemble a $9 \times 10$ rectangle using pieces $1 \times n$.
