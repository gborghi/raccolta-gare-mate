...
quesito: '3'
summary: 'Find positive integers p,q satisfying a given floor/radical equation'
qa_score: '5'
topics:
  - topic_aritmetica
  - topic_algebra
...
> Find positive integers $p$ and $q$ such that
> $$p + q = \lfloor \sqrt{p} \rfloor + \lfloor \sqrt{q} \rfloor + \lfloor \sqrt{p+q} \rfloor.$$
