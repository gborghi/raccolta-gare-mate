...
quesito: '3'
summary: >-
  Among any 18 consecutive 3-digit numbers, one is divisible by sum of its
  digits
qa_score: '5'
topics:
  - topic_aritmetica
...
> Prove that among any $18$ consecutive $3$-digit numbers there is at least one number which is divisible by the sum of its digits.
