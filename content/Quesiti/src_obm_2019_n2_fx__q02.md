...
fase: x
quesito: '2'
summary: Prove inequality involving min and max of two positive integers
qa_score: '3'
topics:
  - topic_aritmetica
methods:
...
> $$\min(a, b) + \text{mdc}(a, b) = k(a + b),$$
> where $\text{mdc}(a,b)$ denotes the greatest common divisor of $a$ and $b$.
> 
> Prove that $a + b \ge 4k$.
