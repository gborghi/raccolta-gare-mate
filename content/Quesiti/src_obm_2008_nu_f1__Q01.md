...
fase: '1'
quesito: '1'
summary: Find all integer n so a cubic has three integer roots
qa_score: '4'
topics:
  - topic_algebra
  - topic_aritmetica
...
# Olimpíada Brasileira de Matemática 2008 — Nível Universitário — Fase 1 — Quesito 1

*Find all integer n so a cubic has three integer roots*

> Determine all integer values of $n$ for which the equation $x^3 - 13x + n = 0$ has three integer roots.
