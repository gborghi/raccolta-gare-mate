...
quesito: '3'
summary: >-
  A quadrilateral-shaped park with several gates; label its points so that the
  numbers along each side add up to the same total T; give an example numbering
  achieving one possible value of T
qa_score: '2'
topics:
  - topic_aritmetica
  - topic_combinatoria
