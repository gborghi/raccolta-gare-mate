...
fase: '1'
quesito: '3'
summary: Volume of a solid built from an elliptic paraboloid and an ellipsoid cap
qa_score: '2'
answer: v = (pi/sqrt(6))(31/300 + 2*sqrt(5)/15 - 7*sqrt(21)/100)
topics:
...
# Olimpíada Brasileira de Matemática 2007 — Nível Universitário — Fase 1 — Quesito 3
