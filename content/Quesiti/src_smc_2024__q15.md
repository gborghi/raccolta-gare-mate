...
quesito: '15'
summary: >-
  Two squares JKLM and NKPO sharing corner K; NL = 10 cm, shaded area 62 cm²;
  find KN
qa_score: '4'
answer: C
topics:
...
> The diagram shows two squares, $JKLM$ and $NKPO$. The length of $NL$ is 10 cm. The shaded region has area 62 cm$^2$. What is the length of $KN$ in cm?
>
> - **(A)** $3$
> - **(B)** $\sqrt{18}$
> - **(C)** $\sqrt{19}$
