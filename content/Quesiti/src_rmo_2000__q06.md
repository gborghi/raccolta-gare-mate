...
quesito: '6'
summary: Find least value of ab such that a^n b^(n+1) is divisible by 2000 for all n
qa_score: '4'
topics:
  - topic_aritmetica
  - topic_algebra
...
> (i) Consider two positive integers $a$ and $b$ such that $a^n b^{n+1}$ is divisible by $2000$ for every positive integer $n$. What is the least possible value of the product $ab$?
> 
> (ii) Consider two positive integers $a$ and $b$ which are such that $a^n b^{n+1}$ is divisible by $2000$ for some positive integer $n$. What is the least possible value of the product $ab$?
