...
quesito: '4'
summary: 'Positive integers x,y,z satisfying x^y + y^z = z^x, prove min(x,y) >= n'
qa_score: '3'
topics:
  - topic_aritmetica
  - topic_algebra
...
> Prove that if positive integers $x, y, z$ satisfy the equation $x^y + y^z = z^x$, then $\min\{x, y\} \ge n$.
