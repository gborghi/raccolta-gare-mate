...
quesito: '3'
summary: 'Infinitely many integer triples satisfying $x^2+y^2=z^{2^l}$ for all $l$'
regioni:
  - Region 3
qa_score: '5'
topics:
...
> Show that there are infinitely many triples $(x, y, z)$ of integers such that $x^2 + y^2 = z^{2^l}$ for all $l$.
