...
> Osserva la figura. Una formica parte dall’esagono indicato 
> con X per raggiungere quello indicato con Y. Nel tragitto deve 
> visitare una X e una sola volta ogni altro esagono e può lasciare un 
> esagono solo per portarsi in uno adiacente (cioè che abbia un lato in 
> comune con esso). Quanti sono i percorsi possibili? 
> A) 2  
>   
> B) 3  
>   
