...
quesito: '3'
summary: >-
  Functional equation f(x+1)=1/2+sqrt(f(x)-f(x)^2): exhibit a continuous
  solution, prove every solution is periodic, and produce infinitely many
  continuous solutions with f(0)=1/2.
qa_score: '5'
topics:
  - topic_funzionali
