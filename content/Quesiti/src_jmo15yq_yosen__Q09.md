...
quesito: '9'
summary: >-
  Find angle PAC with point P inside regular pentagon satisfying given angle
  conditions
qa_score: '3'
answer: 24^\circ
topics:
...
> Let $P$ be a point inside a regular pentagon $ABCDE$ such that $\angle ABP = 6^\circ$ and $\angle AEP = 12^\circ$. Find the measure of $\angle PAC$.
