...
> Nel piano con l’abituale sistema di riferimento cartesiano ortogonale Oxy, è stato segnato sulla parabola di
> equazione y = ax2 + bx + c il punto A≡(1, -10); gli assi e
> gran parte del grafico della parabola sono poi stati cancellati, ed è rimasto ciò che si vede in figura. Quale delle
> affermazioni seguenti può essere falsa?
> A) a > 0
> B) b < 0
> C) a+b+c < 0
> D) b2 > 4ac
