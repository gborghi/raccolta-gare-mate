...
modalita: a squadre
quesito: '4'
summary: Rapporto tra area trapezio ABCD e triangolo ACE
qa_score: '4'
topics:
...
> Sia $S$ l'area del trapezio $ABCD$ e sia $y$ quella del triangolo $ACE$ (nella figura $BD$ è parallelo a $CE$).
> 
