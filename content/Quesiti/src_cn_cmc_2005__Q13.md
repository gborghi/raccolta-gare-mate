---
title: China Mathematical Competition 2005 — Quesito 13
tipo: quesito
quesito_id: quesito_src_cn_cmc_2005__Q13
...
quesito: '13'
summary: >-
  Prove sequence defined by nested radical recurrence yields integers and
  perfect squares
qa_score: '3'
topics:
  - topic_algebra
...
*Prove sequence defined by nested radical recurrence yields integers and perfect squares*

> Given a sequence $\{a_n\}$ satisfying $a_0 = 1$ and
> $$a_{n+1} = \frac{7a_n + \sqrt{45a_n^2 - 36}}{2}, \quad n \in \mathbb{N}.$$
> Prove that:
> 
