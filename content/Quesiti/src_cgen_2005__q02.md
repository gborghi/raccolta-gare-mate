...
quesito: '2'
summary: >-
  A continuous function on [0;1] with f(0)=f(1)=0 satisfying a
  translation-displacement condition; prove f(x)=0 has at least seven solutions,
...
> Let $f:[0;1]\longrightarrow\mathbb{R}$ be a numerical function defined and continuous on the interval $[0;1]$. We suppose that $f(0)=f(1)=0$ and that for all real $x$ of the interval $\left[0;\frac{6}{10}\right]$, $f\left(x+\frac{4}{10}\right)\neq f(x)$.
> 
> **1.** Show that the equation $f(x)=0$ has at least seven solutions on $[0;1]$.
> 
> **2.** Give an example of a function $f$ verifying the hypotheses; we may content ourselves with a clear graphical representation.
