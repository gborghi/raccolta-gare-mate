...
quesito: '2'
summary: Prove S = ab/c + bc/d + cd/a + da/b ≥ 4 and find equality conditions
qa_score: '4'
topics:
...
> $$S = \frac{ab}{c} + \frac{bc}{d} + \frac{cd}{a} + \frac{da}{b}.$$
> Prove that $S$ is not less than $4$, and obtain necessary conditions for $S = 4$.
