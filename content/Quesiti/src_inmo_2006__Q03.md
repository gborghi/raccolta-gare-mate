...
quesito: '3'
summary: 'Find all integer triples (a,b,c) with functional equation f(f(a,b,c))=(a,b,c)'
qa_score: '5'
topics:
  - topic_algebra
...
> Let $X$ denote the set of all triples $(a, b, c)$ of integers. Define a function $f : X \to X$ by
