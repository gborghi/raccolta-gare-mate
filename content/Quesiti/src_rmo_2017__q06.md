...
quesito: '6'
summary: Prove cyclic inequality for reals greater than 1
qa_score: '5'
topics:
...
> Let $x, y, z$ be real numbers, each greater than $1$. Prove that $$\frac{x+1}{y+1} + \frac{y+1}{z+1} + \frac{z+1}{x+1} \le \frac{x-1}{y-1} + \frac{y-1}{z-1} + \frac{z-1}{x-1}.$$
