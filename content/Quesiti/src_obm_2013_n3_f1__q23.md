...
fase: '1'
quesito: '23'
summary: 'Find y where x,y positive integers and x(x+2+4+6+...+4024)=2013^y'
qa_score: '5'
answer: C
topics:
  - topic_algebra
...
> If $x$ and $y$ are positive integers such that $x(x + 2 + 4 + 6 + \cdots + 4024) = 2013^y$, what is the value of $y$?
> 
