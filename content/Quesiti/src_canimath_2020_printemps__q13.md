...
stagione: printemps
quesito: '13'
summary: 'Find all n>=0 with n = 2 s(n), where s(n) is the digit sum'
qa_score: '3'
topics:
  - topic_aritmetica
methods:
...
> For every integer $n \ge 0$, let $s(n)$ denote the sum of the digits of $n$. Determine all integers $n$ such that $n = 2s(n)$.
