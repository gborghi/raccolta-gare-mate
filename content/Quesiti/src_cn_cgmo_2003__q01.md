---
title: China Girls' Mathematical Olympiad 2003 — Quesito 1
tipo: quesito
quesito_id: quesito_src_cn_cgmo_2003__Q01
...
quesito: '1'
summary: Triangle area inequalities with ratio x on segment DE
qa_score: '4'
topics:
...
> Let $ABC$ be a triangle. Points $D$ and $E$ are on sides $AB$ and $AC$ respectively, and point $F$ is on line segment $DE$. Let $\frac{AD}{AC} = \frac{DF}{DE} = x$. Prove that
> $$S_{\triangle CEF} = x(1-x)S_{\triangle ABC}$$
> and
