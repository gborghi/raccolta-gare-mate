...
quesito: '2'
summary: 'Find all positive integers m, n and primes p ≥ 5 satisfying equation'
qa_score: '3'
topics:
  - topic_aritmetica
methods:
...
> Find all positive integers $m$, $n$, and primes $p \ge 5$ such that
> $$m(4m^2 + 12m + 3) = 3(p^n - 1).$$
