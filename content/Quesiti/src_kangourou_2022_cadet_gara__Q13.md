...
quesito: '13'
summary: 'Massimo numero di somme dispari a coppie di X,Y,Z,W'
answer: C
topics:
  - topic_aritmetica
methods:
...
> Denota con X, Y, Z, W quattro numeri interi. Qual è il massimo numero di numeri 
> dispari che puoi ottenere nel calcolare tutte le possibili somme a coppie X + Y, X + Z, 
> X + W, Y + Z, Y + W, Z + W ?
> A) 2	
> 	
> B) 3	
