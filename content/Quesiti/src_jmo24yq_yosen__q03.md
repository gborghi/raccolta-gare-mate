...
quesito: '3'
summary: Sum of 1/(d+sqrt(10)) over all positive divisors d of 10
qa_score: '3'
answer: '\dfrac{3}{16\sqrt{7}}'
topics:
  - topic_algebra
  - topic_aritmetica
methods:
...
> Compute the sum
> $$\sum_{d \mid 10} \frac{1}{d + \sqrt{10}}$$
> where the sum runs over all positive divisors $d$ of $10$.
