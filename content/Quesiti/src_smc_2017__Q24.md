...
quesito: '24'
summary: >-
  Set of n straight lines in the plane where each line meets exactly 10 others;
  which value cannot be n?
qa_score: '3'
answer: D
topics:
  - topic_combinatoria
...
> There is a set of $n$ straight lines in the plane such that each line intersects exactly ten others.
> 
> Which of the following could NOT be the number of lines in the set?
>
> - **(A)** $11$
> - **(B)** $12$
> - **(C)** $15$
