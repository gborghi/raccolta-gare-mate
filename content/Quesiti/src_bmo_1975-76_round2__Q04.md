...
quesito: '4'
summary: 'No positive integers p,q with |sqrt(2)-p/q| ≤ 1/(4q²)'
qa_score: '3'
topics:
  - topic_aritmetica
methods:
...
> Prove that it is not possible to find positive integers $p$ and $q$ with the property that
> $$\left|\sqrt{2} - \frac{p}{q}\right| \leq \frac{1}{4q^2}.$$
