...
quesito: '8'
summary: Count positive integer solutions of x+y+z=2010 with x<=y<=z
qa_score: '2'
answer: $336675$
topics:
  - topic_aritmetica
...
> The number of positive integer solutions of equation $x + y + z = 2010$ with $x \le y \le z$ is ________.
