---
title: Olimpiade Matematica Polacca 2008 — Round 1 — Quesito 2
tipo: quesito
quesito_id: quesito_src_pol_2008_r1__Q02
...
quesito: '2'
summary: >-
  Inside a convex angle with vertex P and a given point A, points X,Y on the
  rays with PX=PY minimize AX+AY; prove angle XAP = angle YAP.
qa_score: '5'
topics:
...
> Inside a convex angle with vertex $P$ is given a point $A$. Points $X$ and $Y$ lie on different rays of the angle so that $PX = PY$ and the sum $AX + AY$ is minimal. Prove that $\angle XAP = \angle YAP$.
