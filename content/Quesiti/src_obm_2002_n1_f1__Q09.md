...
fase: '1'
quesito: '9'
summary: Nature of the difference of squares of two consecutive integers
qa_score: '2'
answer: C
topics:
  - topic_algebra
...
> The difference between the squares of two consecutive positive whole numbers is always:
> 
> (A) a prime number. (B) a multiple of $3$. (C) equal to the sum of these numbers. (D) an odd number. (E) a perfect square.
