...
quesito: '2'
summary: Quale valore N non e possibile per i cioccolatini
answer: E
topics:
  - topic_aritmetica
methods:
...
> (Punti 3) Un certo numero N di cioccolatini è stato suddiviso tra 7 ragazzi in modo che cinque ne 
> abbiano tutti lo stesso numero maggiore di 0 e, dei due restanti, uno ne abbia il doppio dell’altro.
> Allora N
> A) non può essere 19.	
> 	
> B) non può essere 20.
...
> 	
> D) non può essere 22.	
> E) può essere uno qualunque dei numeri che compaiono nelle precedenti risposte.
