---
title: Olimpíada Brasileira de Matemática 2003 — Nível 1 — Fase 3 — Quesito 5
tipo: quesito
quesito_id: quesito_src_obm_2003_n1_f3__Q05
...
quesito: '5'
summary: >-
  Building a rectangle's perimeter from 2003 integer-length rods by breaking
  some: one break not always enough, two breaks always suffice
qa_score: '5'
topics:
  - topic_aritmetica
  - topic_combinatoria
...
> We want to construct the perimeter of a rectangle using $2003$ rods whose measures are positive integers. To do this we will sometimes have to break some of them, but all rods and pieces of rods must be used in the construction of the rectangle.
> 
