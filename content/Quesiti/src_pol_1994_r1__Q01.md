...
quesito: '1'
summary: 'No integers a,b,c,d (not all 0) with a^2-b=c^2 and b^2-a=d^2'
topics:
  - topic_aritmetica
methods:
  - method_casework
...
> Prove that there are no integers $a, b, c, d$, not all equal to 0, such that $a^2 - b = c^2$ and $b^2 - a = d^2$.
