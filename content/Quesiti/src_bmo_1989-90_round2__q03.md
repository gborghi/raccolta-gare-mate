...
quesito: '3'
summary: 'State the cosine rule; prove sqrt(a)+sqrt(b)>sqrt(c) for triangle sides a,b,c'
qa_score: '3'
topics:
...
> 
> Prove that for positive real numbers $a$, $b$, $c$ which are the sides of a triangle,
