...
fase: '1'
quesito: '14'
summary: Maximise fraction M×A×T×E×M / (A×T×E×C×A) with distinct digit letters
qa_score: '3'
answer: E
topics:
  - topic_algebra
...
# Olimpíada Brasileira de Matemática 2012 — Nível 1 — Fase 1 — Quesito 14

*Maximise fraction M×A×T×E×M / (A×T×E×C×A) with distinct digit letters*

> In the expression $\dfrac{M \times A \times T \times E \times M}{A \times T \times E \times C \times A}$, different letters represent different digits and equal letters represent equal digits. What is the maximum possible value of this expression?
> 
