...
fase: x
quesito: '2'
summary: Fixed point and eigenvalue analysis for iterated function composition
qa_score: '3'
topics:
...
# Olimpíada Brasileira de Matemática 2024 — Nível Universitário — Fase x — Quesito 2
