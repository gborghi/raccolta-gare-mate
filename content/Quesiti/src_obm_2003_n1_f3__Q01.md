...
fase: '3'
quesito: '1'
summary: Count positive integers below 1000 whose digit sum is 7
qa_score: '5'
topics:
  - topic_aritmetica
  - topic_combinatoria
...
# Olimpíada Brasileira de Matemática 2003 — Nível 1 — Fase 3 — Quesito 1

*Count positive integers below 1000 whose digit sum is 7*

> How many positive integers less than $1000$ have the sum of their digits equal to $7$?
