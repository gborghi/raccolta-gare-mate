---
title: IMO 2025 (LXVI International Mathematical Olympiad) — Quesito 1
tipo: quesito
lang: it
quesito_id: quesito_src_imho_2025__Q01
...
quesito: '1'
summary: Count sunny lines through lattice points in the plane
qa_score: '5'
topics:
  - topic_combinatoria
...
> 
> Let $n \ge 2$ be a given integer. Determine all nonnegative integers $k$ such that there exist $n$ distinct lines in the plane satisfying both of the following:
> 
